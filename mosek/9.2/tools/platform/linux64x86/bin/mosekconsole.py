...
combinatorial_parameters = {'MSK_IPAR_MIO_PERSPECTIVE_REFORMULATE': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_OPF_WRITE_SOL_BAS': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_SENSITIVITY_OPTIMIZER': {0: 'MSK_OPTIMIZER_CONIC', 1: 'MSK_OPTIMIZER_DUAL_SIMPLEX', 2: 'MSK_OPTIMIZER_FREE', 3: 'MSK_OPTIMIZER_FREE_SIMPLEX', 4: 'MSK_OPTIMIZER_INTPNT', 5: 'MSK_OPTIMIZER_MIXED_INT', 6: 'MSK_OPTIMIZER_PRIMAL_SIMPLEX'}, 'MSK_IPAR_INTPNT_SCALING': {0: 'MSK_SCALING_FREE', 1: 'MSK_SCALING_NONE', 2: 'MSK_SCALING_MODERATE', 3: 'MSK_SCALING_AGGRESSIVE'}, 'MSK_IPAR_ANA_SOL_BASIS': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_INTPNT_PURIFY': {0: 'MSK_PURIFY_NONE', 1: 'MSK_PURIFY_PRIMAL', 2: 'MSK_PURIFY_DUAL', 3: 'MSK_PURIFY_PRIMAL_DUAL', 4: 'MSK_PURIFY_AUTO'}, 'MSK_IPAR_BI_CLEAN_OPTIMIZER': {0: 'MSK_OPTIMIZER_CONIC', 1: 'MSK_OPTIMIZER_DUAL_SIMPLEX', 2: 'MSK_OPTIMIZER_FREE', 3: 'MSK_OPTIMIZER_FREE_SIMPLEX', 4: 'MSK_OPTIMIZER_INTPNT', 5: 'MSK_OPTIMIZER_MIXED_INT', 6: 'MSK_OPTIMIZER_PRIMAL_SIMPLEX'}, 'MSK_IPAR_SIM_SWITCH_OPTIMIZER': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_PRIMAL_REPAIR_OPTIMIZER': {0: 'MSK_OPTIMIZER_CONIC', 1: 'MSK_OPTIMIZER_DUAL_SIMPLEX', 2: 'MSK_OPTIMIZER_FREE', 3: 'MSK_OPTIMIZER_FREE_SIMPLEX', 4: 'MSK_OPTIMIZER_INTPNT', 5: 'MSK_OPTIMIZER_MIXED_INT', 6: 'MSK_OPTIMIZER_PRIMAL_SIMPLEX'}, 'MSK_IPAR_SIM_REFORMULATION': {0: 'MSK_SIM_REFORMULATION_OFF', 1: 'MSK_SIM_REFORMULATION_ON', 2: 'MSK_SIM_REFORMULATION_FREE', 3: 'MSK_SIM_REFORMULATION_AGGRESSIVE'}, 'MSK_IPAR_LOG_LOCAL_INFO': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_WRITE_SOL_CONSTRAINTS': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_SIM_SAVE_LU': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_WRITE_XML_MODE': {0: 'MSK_WRITE_XML_MODE_ROW', 1: 'MSK_WRITE_XML_MODE_COL'}, 'MSK_IPAR_SOL_FILTER_KEEP_BASIC': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_MIO_CUT_IMPLIED_BOUND': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_READ_DEBUG': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_OPF_WRITE_PARAMETERS': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_READ_KEEP_FREE_CON': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_INFEAS_PREFER_PRIMAL': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_WRITE_DATA_PARAM': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_WRITE_SOL_IGNORE_INVALID_NAMES': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_SIM_DEGEN': {0: 'MSK_SIM_DEGEN_NONE', 1: 'MSK_SIM_DEGEN_FREE', 2: 'MSK_SIM_DEGEN_AGGRESSIVE', 3: 'MSK_SIM_DEGEN_MODERATE', 4: 'MSK_SIM_DEGEN_MINIMUM'}, 'MSK_IPAR_SIM_NON_SINGULAR': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_BASIS_SOLVE_USE_PLUS_ONE': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_SOLUTION_CALLBACK': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_WRITE_BAS_CONSTRAINTS': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_BI_IGNORE_NUM_ERROR': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_LICENSE_WAIT': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_INTPNT_BASIS': {0: 'MSK_BI_NEVER', 1: 'MSK_BI_ALWAYS', 2: 'MSK_BI_NO_ERROR', 3: 'MSK_BI_IF_FEASIBLE', 4: 'MSK_BI_RESERVERED'}, 'MSK_IPAR_READ_MPS_FORMAT': {0: 'MSK_MPS_FORMAT_STRICT', 1: 'MSK_MPS_FORMAT_RELAXED', 2: 'MSK_MPS_FORMAT_FREE', 3: 'MSK_MPS_FORMAT_CPLEX'}, 'MSK_IPAR_OPTIMIZER': {0: 'MSK_OPTIMIZER_CONIC', 1: 'MSK_OPTIMIZER_DUAL_SIMPLEX', 2: 'MSK_OPTIMIZER_FREE', 3: 'MSK_OPTIMIZER_FREE_SIMPLEX', 4: 'MSK_OPTIMIZER_INTPNT', 5: 'MSK_OPTIMIZER_MIXED_INT', 6: 'MSK_OPTIMIZER_PRIMAL_SIMPLEX'}, 'MSK_IPAR_WRITE_MPS_FORMAT': {0: 'MSK_MPS_FORMAT_STRICT', 1: 'MSK_MPS_FORMAT_RELAXED', 2: 'MSK_MPS_FORMAT_FREE', 3: 'MSK_MPS_FORMAT_CPLEX'}, 'MSK_IPAR_OPF_WRITE_HINTS': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_ANA_SOL_PRINT_VIOLATED': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_MIO_ROOT_OPTIMIZER': {0: 'MSK_OPTIMIZER_CONIC', 1: 'MSK_OPTIMIZER_DUAL_SIMPLEX', 2: 'MSK_OPTIMIZER_FREE', 3: 'MSK_OPTIMIZER_FREE_SIMPLEX', 4: 'MSK_OPTIMIZER_INTPNT', 5: 'MSK_OPTIMIZER_MIXED_INT', 6: 'MSK_OPTIMIZER_PRIMAL_SIMPLEX'}, 'MSK_IPAR_OPF_WRITE_SOL_ITR': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_READ_TASK_IGNORE_PARAM': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_SIM_SOLVE_FORM': {0: 'MSK_SOLVE_FREE', 1: 'MSK_SOLVE_PRIMAL', 2: 'MSK_SOLVE_DUAL'}, 'MSK_IPAR_WRITE_IGNORE_INCOMPATIBLE_ITEMS': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_LOG_INCLUDE_SUMMARY': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_AUTO_UPDATE_SOL_INFO': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_SIM_PRIMAL_SELECTION': {0: 'MSK_SIM_SELECTION_FREE', 1: 'MSK_SIM_SELECTION_FULL', 2: 'MSK_SIM_SELECTION_ASE', 3: 'MSK_SIM_SELECTION_DEVEX', 4: 'MSK_SIM_SELECTION_SE', 5: 'MSK_SIM_SELECTION_PARTIAL'}, 'MSK_IPAR_SIM_SCALING_METHOD': {0: 'MSK_SCALING_METHOD_POW2', 1: 'MSK_SCALING_METHOD_FREE'}, 'MSK_IPAR_OPF_WRITE_SOLUTIONS': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_SIM_SCALING': {0: 'MSK_SCALING_FREE', 1: 'MSK_SCALING_NONE', 2: 'MSK_SCALING_MODERATE', 3: 'MSK_SCALING_AGGRESSIVE'}, 'MSK_IPAR_INFEAS_GENERIC_NAMES': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_OPF_WRITE_SOL_ITG': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_WRITE_GENERIC_NAMES': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_SOL_FILTER_KEEP_RANGED': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_INTPNT_SOLVE_FORM': {0: 'MSK_SOLVE_FREE', 1: 'MSK_SOLVE_PRIMAL', 2: 'MSK_SOLVE_DUAL'}, 'MSK_IPAR_PRESOLVE_LINDEP_USE': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_MIO_NODE_OPTIMIZER': {0: 'MSK_OPTIMIZER_CONIC', 1: 'MSK_OPTIMIZER_DUAL_SIMPLEX', 2: 'MSK_OPTIMIZER_FREE', 3: 'MSK_OPTIMIZER_FREE_SIMPLEX', 4: 'MSK_OPTIMIZER_INTPNT', 5: 'MSK_OPTIMIZER_MIXED_INT', 6: 'MSK_OPTIMIZER_PRIMAL_SIMPLEX'}, 'MSK_IPAR_MIO_NODE_SELECTION': {0: 'MSK_MIO_NODE_SELECTION_FREE', 1: 'MSK_MIO_NODE_SELECTION_FIRST', 2: 'MSK_MIO_NODE_SELECTION_BEST', 3: 'MSK_MIO_NODE_SELECTION_PSEUDO'}, 'MSK_IPAR_SIM_EXPLOIT_DUPVEC': {0: 'MSK_SIM_EXPLOIT_DUPVEC_OFF', 1: 'MSK_SIM_EXPLOIT_DUPVEC_ON', 2: 'MSK_SIM_EXPLOIT_DUPVEC_FREE'}, 'MSK_IPAR_WRITE_LP_FULL_OBJ': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_WRITE_SOL_HEAD': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_WRITE_INT_CONSTRAINTS': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_WRITE_BAS_HEAD': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_READ_LP_QUOTED_NAMES': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_COMPRESS_STATFILE': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_MIO_CONIC_OUTER_APPROXIMATION': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_SENSITIVITY_ALL': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_WRITE_FREE_CON': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_MIO_PROPAGATE_OBJECTIVE_CONSTRAINT': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_WRITE_TASK_INC_SOL': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_WRITE_INT_VARIABLES': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_SIM_BASIS_FACTOR_USE': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_INTPNT_HOTSTART': {0: 'MSK_INTPNT_HOTSTART_NONE', 1: 'MSK_INTPNT_HOTSTART_PRIMAL', 2: 'MSK_INTPNT_HOTSTART_DUAL', 3: 'MSK_INTPNT_HOTSTART_PRIMAL_DUAL'}, 'MSK_IPAR_INTPNT_REGULARIZATION_USE': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_SIM_DUAL_SELECTION': {0: 'MSK_SIM_SELECTION_FREE', 1: 'MSK_SIM_SELECTION_FULL', 2: 'MSK_SIM_SELECTION_ASE', 3: 'MSK_SIM_SELECTION_DEVEX', 4: 'MSK_SIM_SELECTION_SE', 5: 'MSK_SIM_SELECTION_PARTIAL'}, 'MSK_IPAR_INTPNT_STARTING_POINT': {0: 'MSK_STARTING_POINT_FREE', 1: 'MSK_STARTING_POINT_GUESS', 2: 'MSK_STARTING_POINT_CONSTANT', 3: 'MSK_STARTING_POINT_SATISFY_BOUNDS'}, 'MSK_IPAR_SENSITIVITY_TYPE': {0: 'MSK_SENSITIVITY_TYPE_BASIS'}, 'MSK_IPAR_CACHE_LICENSE': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_MIO_MODE': {0: 'MSK_MIO_MODE_IGNORED', 1: 'MSK_MIO_MODE_SATISFIED'}, 'MSK_IPAR_WRITE_LP_QUOTED_NAMES': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_MIO_CUT_GMI': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_WRITE_INT_HEAD': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_WRITE_MPS_INT': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_PARAM_READ_IGN_ERROR': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_CHECK_CONVEXITY': {0: 'MSK_CHECK_CONVEXITY_NONE', 1: 'MSK_CHECK_CONVEXITY_SIMPLE', 2: 'MSK_CHECK_CONVEXITY_FULL'}, 'MSK_IPAR_LICENSE_DEBUG': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_MIO_CUT_CMIR': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_PTF_WRITE_TRANSFORM': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_BI_IGNORE_MAX_ITER': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_LICENSE_SUPPRESS_EXPIRE_WRNS': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_MIO_CUT_CLIQUE': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_WRITE_SOL_BARVARIABLES': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_WRITE_LP_STRICT_FORMAT': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_INTPNT_DIFF_STEP': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_INFEAS_REPORT_AUTO': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_WRITE_SOL_VARIABLES': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_WRITE_BAS_VARIABLES': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_MIO_CUT_KNAPSACK_COVER': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_INTPNT_MULTI_THREAD': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_SIM_HOTSTART': {0: 'MSK_SIM_HOTSTART_NONE', 1: 'MSK_SIM_HOTSTART_FREE', 2: 'MSK_SIM_HOTSTART_STATUS_KEYS'}, 'MSK_IPAR_PARAM_READ_CASE_NAME': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_OPF_WRITE_HEADER': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_MIO_BRANCH_DIR': {0: 'MSK_BRANCH_DIR_FREE', 1: 'MSK_BRANCH_DIR_UP', 2: 'MSK_BRANCH_DIR_DOWN', 3: 'MSK_BRANCH_DIR_NEAR', 4: 'MSK_BRANCH_DIR_FAR', 5: 'MSK_BRANCH_DIR_ROOT_LP', 6: 'MSK_BRANCH_DIR_GUIDED', 7: 'MSK_BRANCH_DIR_PSEUDOCOST'}, 'MSK_IPAR_OPF_WRITE_PROBLEM': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_PRESOLVE_USE': {0: 'MSK_PRESOLVE_MODE_OFF', 1: 'MSK_PRESOLVE_MODE_ON', 2: 'MSK_PRESOLVE_MODE_FREE'}, 'MSK_IPAR_REMOVE_UNUSED_SOLUTIONS': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_READ_LP_DROP_NEW_VARS_IN_BOU': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_SIM_HOTSTART_LU': {0: 'MSK_OFF', 1: 'MSK_ON'}, 'MSK_IPAR_INTPNT_ORDER_METHOD': {0: 'MSK_ORDER_METHOD_FREE', 1: 'MSK_ORDER_METHOD_APPMINLOC', 2: 'MSK_ORDER_METHOD_EXPERIMENTAL', 3: 'MSK_ORDER_METHOD_TRY_GRAPHPAR', 4: 'MSK_ORDER_METHOD_FORCE_GRAPHPAR', 5: 'MSK_ORDER_METHOD_NONE'}, 'MSK_IPAR_AUTO_SORT_A_BEFORE_OPT': {0: 'MSK_OFF', 1: 'MSK_ON'}}
