...
Env_init(mosek_EnvObject *self, PyObject *args, PyObject *kwds)
{
...

    {
      ...
      MSK_linkfunctoenvstream(self->ptr,MSK_STREAM_LOG,self,log_env_stream_func);
      MSK_linkfunctoenvstream(self->ptr,MSK_STREAM_MSG,self,msg_env_stream_func);
      MSK_linkfunctoenvstream(self->ptr,MSK_STREAM_WRN,self,wrn_env_stream_func);
      MSK_linkfunctoenvstream(self->ptr,MSK_STREAM_ERR,self,err_env_stream_func);
...
static int MSKAPI callback_func(MSKtask_t t, mosek_TaskObject * self, MSKcallbackcodee code, double * dinf, int * iinf, long long * liinf)
{
  ...
  if (self->callback_func || self->infocallback_func)
  {
    ...
    if (self->infocallback_func && callback_res == 0 && dinf && iinf && liinf)
    {
           ...
           NULL != (liinf_obj = PyList_New(MSK_LIINF_END)))
      {
        ...
        for (i = 0; i < MSK_IINF_END; ++i)  PyList_SET_ITEM(iinf_obj,  i, PyInt_FromLong(iinf[i]));
...
static int Task_init(mosek_TaskObject *self, PyObject *args, PyObject *kwds)
{
  PyObject *env_o = NULL, * other_o = NULL;
    ...
    if (other_o == NULL && ! Env_check(env_o)) {
      ...
      MSK_linkfunctotaskstream(self->ptr,MSK_STREAM_LOG,self,log_task_stream_func);
      MSK_linkfunctotaskstream(self->ptr,MSK_STREAM_MSG,self,msg_task_stream_func);
      MSK_linkfunctotaskstream(self->ptr,MSK_STREAM_WRN,self,wrn_task_stream_func);
      MSK_linkfunctotaskstream(self->ptr,MSK_STREAM_ERR,self,err_task_stream_func);
...
static int buffer_continuous_1d_type(Py_buffer * b, const char * fmt)
{  
  return ( b->ndim == 1 &&
           0 == strcmp(b->format, fmt) &&
           (b->strides == NULL || b->strides[0] == b->itemsize));  
}

static int buffer_continuous_1d_int32(Py_buffer * b)
{  
  return ( b->ndim == 1 &&
           b->format[0] == '<' &&
           (( b->format[1] == 'i' && sizeof(int) == 4) ||
            ( b->format[1] == 'l' && sizeof(long) == 4)) &&
           (b->strides == NULL || b->strides[0] == b->itemsize));  
}

static int buffer_continuous_1d_size(Py_buffer * b, int size)
{  
  return ( b->ndim == 1 &&
           b->itemsize == size &&
           (b->strides == NULL || b->strides[0] == b->itemsize));
...
static PyObject * PyMSK_analyzeproblem(mosek_TaskObject * self, PyObject * _args)
{
...
static PyObject * PyMSK_analyzenames(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKstreamtypee _arg1_whichstream;
...
static PyObject * PyMSK_analyzesolution(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKstreamtypee _arg1_whichstream;
...
static PyObject * PyMSK_initbasissolve(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  ...
  if (Py_None != memview__arg1_basis)
  {
    ...
    if (buf__arg1_basis->strides != NULL && buf__arg1_basis->strides[0] != sizeof(int))
    {
...
static PyObject * PyMSK_solvewithbasis(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_transp;
  int _arg2_numnz;
  ...
  if (Py_None != memview__arg3_sub)
  {
    ...
    if (buf__arg3_sub->strides != NULL && buf__arg3_sub->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg4_val)
  {
    ...
    if (buf__arg4_val->strides != NULL && buf__arg4_val->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_basiscond(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  double _arg1_nrmbasis;
  double _arg2_nrminvbasis;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyObject * PyMSK_appendcons(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
...
static PyObject * PyMSK_appendvars(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  if (! PyArg_ParseTuple(_args,"i",&_arg1_num)) goto ERROR;
...
static PyObject * PyMSK_removecons(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  ...
  if (Py_None != memview__arg2_subset)
  {
    ...
    if (buf__arg2_subset->strides != NULL && buf__arg2_subset->strides[0] != sizeof(int))
    {
...
static PyObject * PyMSK_removevars(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  PyObject * memview__arg2_subset = NULL;
...
static PyObject * PyMSK_removebarvars(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  PyObject * memview__arg2_subset = NULL;
...
static PyObject * PyMSK_removecones(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  PyObject * memview__arg2_subset = NULL;
...
static PyObject * PyMSK_appendbarvars(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  ...
  if (Py_None != memview__arg2_dim)
  {
    ...
    if (buf__arg2_dim->strides != NULL && buf__arg2_dim->strides[0] != sizeof(int))
    {
...
static PyObject * PyMSK_appendcone(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  ...
  if (Py_None != memview__arg4_submem)
  {
    ...
    if (buf__arg4_submem->strides != NULL && buf__arg4_submem->strides[0] != sizeof(int))
    {
...
static PyObject * PyMSK_appendconeseq(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKconetypee _arg1_ct;
  double _arg2_conepar;
...
static PyObject * PyMSK_appendconesseq(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  ...
  if (Py_None != memview__arg2_ct)
  {
    ...
    if (buf__arg2_ct->strides != NULL && buf__arg2_ct->strides[0] != sizeof(MSKconetypee))
    {
  ...
  if (Py_None != memview__arg3_conepar)
  {
    ...
    if (buf__arg3_conepar->strides != NULL && buf__arg3_conepar->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg4_nummem)
  {
    ...
    if (buf__arg4_nummem->strides != NULL && buf__arg4_nummem->strides[0] != sizeof(int))
    {
...
static PyObject * PyMSK_chgconbound(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
  int _arg2_lower;
...
static PyObject * PyMSK_chgvarbound(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_j;
  int _arg2_lower;
...
static PyObject * PyMSK_getaij(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
  int _arg2_j;
...
static PyObject * PyMSK_getapiecenumnz(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_firsti;
  int _arg2_lasti;
...
static PyObject * PyMSK_getacolnumnz(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
  int _arg2_nzj;
...
static PyObject * PyMSK_getacol(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_j;
  int _arg2_nzj;
  ...
  if (Py_None != memview__arg3_subj)
  {
    ...
    if (buf__arg3_subj->strides != NULL && buf__arg3_subj->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg4_valj)
  {
    ...
    if (buf__arg4_valj->strides != NULL && buf__arg4_valj->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getacolslice64(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_first;
  int _arg2_last;
  long long _arg3_maxnumnz;
  long long _arg4_surp;
  ...
  if (Py_None != memview__arg5_ptrb)
  {
    ...
    if (buf__arg5_ptrb->strides != NULL && buf__arg5_ptrb->strides[0] != sizeof(long long))
    {
  ...
  if (Py_None != memview__arg6_ptre)
  {
    ...
    if (buf__arg6_ptre->strides != NULL && buf__arg6_ptre->strides[0] != sizeof(long long))
    {
  ...
  if (Py_None != memview__arg7_sub)
  {
    ...
    if (buf__arg7_sub->strides != NULL && buf__arg7_sub->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg8_val)
  {
    ...
    if (buf__arg8_val->strides != NULL && buf__arg8_val->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getarownumnz(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
  int _arg2_nzi;
...
static PyObject * PyMSK_getarow(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
  int _arg2_nzi;
  ...
  if (Py_None != memview__arg3_subi)
  {
    ...
    if (buf__arg3_subi->strides != NULL && buf__arg3_subi->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg4_vali)
  {
    ...
    if (buf__arg4_vali->strides != NULL && buf__arg4_vali->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getacolslicenumnz64(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_first;
  int _arg2_last;
  long long _arg3_numnz;
...
static PyObject * PyMSK_getarowslicenumnz64(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_first;
  int _arg2_last;
...
static PyObject * PyMSK_getarowslice64(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_first;
  int _arg2_last;
...
static PyObject * PyMSK_getarowslicetrip(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_first;
  int _arg2_last;
  ...
  if (Py_None != memview__arg5_subi)
  {
    ...
    if (buf__arg5_subi->strides != NULL && buf__arg5_subi->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg6_subj)
  {
    ...
    if (buf__arg6_subj->strides != NULL && buf__arg6_subj->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg7_val)
  {
    ...
    if (buf__arg7_val->strides != NULL && buf__arg7_val->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getacolslicetrip(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_first;
  int _arg2_last;
...
static PyObject * PyMSK_getconbound(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
  MSKboundkeye _arg2_bk;
  double _arg3_bl;
  double _arg4_bu;
  if (! PyArg_ParseTuple(_args,"i",&_arg1_i)) goto ERROR;
  {
...
static PyObject * PyMSK_getvarbound(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
  MSKboundkeye _arg2_bk;
...
static PyObject * PyMSK_getconboundslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_first;
  int _arg2_last;
  ...
  if (Py_None != memview__arg3_bk)
  {
    ...
    if (buf__arg3_bk->strides != NULL && buf__arg3_bk->strides[0] != sizeof(MSKboundkeye))
    {
  ...
  if (Py_None != memview__arg4_bl)
  {
    ...
    if (buf__arg4_bl->strides != NULL && buf__arg4_bl->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg5_bu)
  {
    ...
    if (buf__arg5_bu->strides != NULL && buf__arg5_bu->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getvarboundslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_first;
  int _arg2_last;
...
static PyObject * PyMSK_getcj(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_j;
  double _arg2_cj;
...
static PyObject * PyMSK_getc(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  ...
  if (Py_None != memview__arg1_c)
  {
    ...
    if (buf__arg1_c->strides != NULL && buf__arg1_c->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getcfix(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  double _arg1_cfix;
  {
...
static PyObject * PyMSK_getcone(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_k;
  ...
  if (Py_None != memview__arg5_submem)
  {
    ...
    if (buf__arg5_submem->strides != NULL && buf__arg5_submem->strides[0] != sizeof(int))
    {
...
static PyObject * PyMSK_getconeinfo(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_k;
  MSKconetypee _arg2_ct;
...
static PyObject * PyMSK_getclist(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  ...
  if (Py_None != memview__arg2_subj)
  {
    ...
    if (buf__arg2_subj->strides != NULL && buf__arg2_subj->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg3_c)
  {
    ...
    if (buf__arg3_c->strides != NULL && buf__arg3_c->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getcslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_first;
  int _arg2_last;
...
static PyObject * PyMSK_getdouinf(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_getdouparam(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_getdualobj(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  double _arg2_dualobj;
...
static PyObject * PyMSK_getintinf(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_getlintinf(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKliinfiteme _arg1_whichliinf;
  long long _arg2_ivalue;
...
static PyObject * PyMSK_getintparam(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_getmaxnumanz64(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_getmaxnumcon(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_maxnumcon;
  {
...
static PyObject * PyMSK_getmaxnumvar(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_maxnumvar;
  {
...
static PyObject * PyMSK_getbarvarnamelen(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
  int _arg2_len;
...
static PyObject * PyMSK_getbarvarname(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
  int _arg2_sizename;
...
static PyObject * PyMSK_getbarvarnameindex(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_generatevarnames(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  PyObject * memview__arg2_subj = NULL;
  ...
  if (Py_None != memview__arg5_dims)
  {
    ...
    if (buf__arg5_dims->strides != NULL && buf__arg5_dims->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg6_sp)
  {
    ...
    if (buf__arg6_sp->strides != NULL && buf__arg6_sp->strides[0] != sizeof(long long))
    {
...
static PyObject * PyMSK_generateconnames(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  ...
  if (Py_None != memview__arg2_subi)
  {
    ...
    if (buf__arg2_subi->strides != NULL && buf__arg2_subi->strides[0] != sizeof(int))
    {
...
static PyObject * PyMSK_generateconenames(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  ...
  if (Py_None != memview__arg2_subk)
  {
    ...
    if (buf__arg2_subk->strides != NULL && buf__arg2_subk->strides[0] != sizeof(int))
    {
...
static PyObject * PyMSK_putconname(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
...
static PyObject * PyMSK_putvarname(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_j;
  char * str__arg2_name = NULL;
...
static PyObject * PyMSK_putconename(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_j;
  char * str__arg2_name = NULL;
...
static PyObject * PyMSK_putbarvarname(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_j;
  char * str__arg2_name = NULL;
...
static PyObject * PyMSK_getvarnamelen(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
  int _arg2_len;
...
static PyObject * PyMSK_getvarname(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_j;
  int _arg2_sizename;
...
static PyObject * PyMSK_getconnamelen(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
  int _arg2_len;
...
static PyObject * PyMSK_getconname(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
  int _arg2_sizename;
...
static PyObject * PyMSK_getconnameindex(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_somename = NULL;
  int _arg2_asgn;
...
static PyObject * PyMSK_getvarnameindex(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_somename = NULL;
  int _arg2_asgn;
...
static PyObject * PyMSK_getconenamelen(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
  int _arg2_len;
...
static PyObject * PyMSK_getconename(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
  int _arg2_sizename;
...
static PyObject * PyMSK_getconenameindex(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_somename = NULL;
  int _arg2_asgn;
...
static PyObject * PyMSK_getnumanz(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_numanz;
  {
...
static PyObject * PyMSK_getnumanz64(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_numanz;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyObject * PyMSK_getnumcon(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_numcon;
  {
...
static PyObject * PyMSK_getnumcone(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_numcone;
  {
...
static PyObject * PyMSK_getnumconemem(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_k;
  int _arg2_nummem;
...
static PyObject * PyMSK_getnumintvar(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_numintvar;
  {
...
static PyObject * PyMSK_getnumparam(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_getnumqconknz64(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_k;
  long long _arg2_numqcnz;
  if (! PyArg_ParseTuple(_args,"i",&_arg1_k)) goto ERROR;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyObject * PyMSK_getnumqobjnz64(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_numqonz;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyObject * PyMSK_getnumvar(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_numvar;
  {
...
static PyObject * PyMSK_getnumbarvar(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_numbarvar;
  {
...
static PyObject * PyMSK_getmaxnumbarvar(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_getdimbarvarj(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_j;
  int _arg2_dimbarvarj;
  if (! PyArg_ParseTuple(_args,"i",&_arg1_j)) goto ERROR;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyObject * PyMSK_getlenbarvarj(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_j;
  long long _arg2_lenbarvarj;
  if (! PyArg_ParseTuple(_args,"i",&_arg1_j)) goto ERROR;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyObject * PyMSK_getobjname(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_getobjnamelen(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_len;
  {
...
static PyObject * PyMSK_getprimalobj(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  double _arg2_primalobj;
  if (! PyArg_ParseTuple(_args,"i",&_arg1_whichsol)) goto ERROR;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyObject * PyMSK_getprobtype(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKproblemtypee _arg1_probtype;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyObject * PyMSK_getqconk64(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_k;
  long long _arg2_maxnumqcnz;
  long long _arg3_qcsurp;
  long long _arg4_numqcnz;
  ...
  if (Py_None != memview__arg5_qcsubi)
  {
    ...
    if (buf__arg5_qcsubi->strides != NULL && buf__arg5_qcsubi->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg6_qcsubj)
  {
    ...
    if (buf__arg6_qcsubj->strides != NULL && buf__arg6_qcsubj->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg7_qcval)
  {
    ...
    if (buf__arg7_qcval->strides != NULL && buf__arg7_qcval->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getqobj64(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_maxnumqonz;
  long long _arg2_qosurp;
  long long _arg3_numqonz;
  ...
  if (Py_None != memview__arg4_qosubi)
  {
    ...
    if (buf__arg4_qosubi->strides != NULL && buf__arg4_qosubi->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg5_qosubj)
  {
    ...
    if (buf__arg5_qosubj->strides != NULL && buf__arg5_qosubj->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg6_qoval)
  {
    ...
    if (buf__arg6_qoval->strides != NULL && buf__arg6_qoval->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getqobjij(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
  int _arg2_j;
...
static PyObject * PyMSK_getsolution(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  MSKprostae _arg2_prosta;
  MSKsolstae _arg3_solsta;
  ...
  if (Py_None != memview__arg4_skc)
  {
    ...
    if (buf__arg4_skc->strides != NULL && buf__arg4_skc->strides[0] != sizeof(MSKstakeye))
    {
  ...
  if (Py_None != memview__arg5_skx)
  {
    ...
    if (buf__arg5_skx->strides != NULL && buf__arg5_skx->strides[0] != sizeof(MSKstakeye))
    {
  ...
  if (Py_None != memview__arg6_skn)
  {
    ...
    if (buf__arg6_skn->strides != NULL && buf__arg6_skn->strides[0] != sizeof(MSKstakeye))
    {
  ...
  if (Py_None != memview__arg7_xc)
  {
    ...
    if (buf__arg7_xc->strides != NULL && buf__arg7_xc->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg8_xx)
  {
    ...
    if (buf__arg8_xx->strides != NULL && buf__arg8_xx->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg9_y)
  {
    ...
    if (buf__arg9_y->strides != NULL && buf__arg9_y->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg10_slc)
  {
    ...
    if (buf__arg10_slc->strides != NULL && buf__arg10_slc->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg11_suc)
  {
    ...
    if (buf__arg11_suc->strides != NULL && buf__arg11_suc->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg12_slx)
  {
    ...
    if (buf__arg12_slx->strides != NULL && buf__arg12_slx->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg13_sux)
  {
    ...
    if (buf__arg13_sux->strides != NULL && buf__arg13_sux->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg14_snx)
  {
    ...
    if (buf__arg14_snx->strides != NULL && buf__arg14_snx->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getsolsta(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  MSKsolstae _arg2_solsta;
  if (! PyArg_ParseTuple(_args,"i",&_arg1_whichsol)) goto ERROR;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyObject * PyMSK_getprosta(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  MSKprostae _arg2_prosta;
...
static PyObject * PyMSK_getskc(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  ...
  if (Py_None != memview__arg2_skc)
  {
    ...
    if (buf__arg2_skc->strides != NULL && buf__arg2_skc->strides[0] != sizeof(MSKstakeye))
    {
...
static PyObject * PyMSK_getskx(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  ...
  if (Py_None != memview__arg2_skx)
  {
    ...
    if (buf__arg2_skx->strides != NULL && buf__arg2_skx->strides[0] != sizeof(MSKstakeye))
    {
...
static PyObject * PyMSK_getskn(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  ...
  if (Py_None != memview__arg2_skn)
  {
    ...
    if (buf__arg2_skn->strides != NULL && buf__arg2_skn->strides[0] != sizeof(MSKstakeye))
    {
...
static PyObject * PyMSK_getxc(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  ...
  if (Py_None != memview__arg2_xc)
  {
    ...
    if (buf__arg2_xc->strides != NULL && buf__arg2_xc->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getxx(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  ...
  if (Py_None != memview__arg2_xx)
  {
    ...
    if (buf__arg2_xx->strides != NULL && buf__arg2_xx->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_gety(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  ...
  if (Py_None != memview__arg2_y)
  {
    ...
    if (buf__arg2_y->strides != NULL && buf__arg2_y->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getslc(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  ...
  if (Py_None != memview__arg2_slc)
  {
    ...
    if (buf__arg2_slc->strides != NULL && buf__arg2_slc->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getsuc(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  ...
  if (Py_None != memview__arg2_suc)
  {
    ...
    if (buf__arg2_suc->strides != NULL && buf__arg2_suc->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getslx(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  ...
  if (Py_None != memview__arg2_slx)
  {
    ...
    if (buf__arg2_slx->strides != NULL && buf__arg2_slx->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getsux(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  ...
  if (Py_None != memview__arg2_sux)
  {
    ...
    if (buf__arg2_sux->strides != NULL && buf__arg2_sux->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getsnx(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  ...
  if (Py_None != memview__arg2_snx)
  {
    ...
    if (buf__arg2_snx->strides != NULL && buf__arg2_snx->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getskcslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
...
static PyObject * PyMSK_getskxslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
  ...
  if (Py_None != memview__arg4_skx)
  {
    ...
    if (buf__arg4_skx->strides != NULL && buf__arg4_skx->strides[0] != sizeof(MSKstakeye))
    {
...
static PyObject * PyMSK_getxcslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
  ...
  if (Py_None != memview__arg4_xc)
  {
    ...
    if (buf__arg4_xc->strides != NULL && buf__arg4_xc->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getxxslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
  ...
  if (Py_None != memview__arg4_xx)
  {
    ...
    if (buf__arg4_xx->strides != NULL && buf__arg4_xx->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getyslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
  ...
  if (Py_None != memview__arg4_y)
  {
    ...
    if (buf__arg4_y->strides != NULL && buf__arg4_y->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getslcslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
  ...
  if (Py_None != memview__arg4_slc)
  {
    ...
    if (buf__arg4_slc->strides != NULL && buf__arg4_slc->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getsucslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
  ...
  if (Py_None != memview__arg4_suc)
  {
    ...
    if (buf__arg4_suc->strides != NULL && buf__arg4_suc->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getslxslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
  ...
  if (Py_None != memview__arg4_slx)
  {
    ...
    if (buf__arg4_slx->strides != NULL && buf__arg4_slx->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getsuxslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
  ...
  if (Py_None != memview__arg4_sux)
  {
    ...
    if (buf__arg4_sux->strides != NULL && buf__arg4_sux->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getsnxslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
  ...
  if (Py_None != memview__arg4_snx)
  {
    ...
    if (buf__arg4_snx->strides != NULL && buf__arg4_snx->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getbarxj(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_j;
  ...
  if (Py_None != memview__arg3_barxj)
  {
    ...
    if (buf__arg3_barxj->strides != NULL && buf__arg3_barxj->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getbarxslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
  ...
  if (Py_None != memview__arg5_barxslice)
  {
    ...
    if (buf__arg5_barxslice->strides != NULL && buf__arg5_barxslice->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getbarsj(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_j;
  ...
  if (Py_None != memview__arg3_barsj)
  {
    ...
    if (buf__arg3_barsj->strides != NULL && buf__arg3_barsj->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getbarsslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
  ...
  if (Py_None != memview__arg5_barsslice)
  {
    ...
    if (buf__arg5_barsslice->strides != NULL && buf__arg5_barsslice->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_putskc(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  PyObject * memview__arg2_skc = NULL;
...
static PyObject * PyMSK_putskx(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  PyObject * memview__arg2_skx = NULL;
...
static PyObject * PyMSK_putxc(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  PyObject * memview__arg2_xc = NULL;
...
static PyObject * PyMSK_putxx(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  PyObject * memview__arg2_xx = NULL;
...
static PyObject * PyMSK_puty(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  PyObject * memview__arg2_y = NULL;
...
static PyObject * PyMSK_putslc(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  PyObject * memview__arg2_slc = NULL;
...
static PyObject * PyMSK_putsuc(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  PyObject * memview__arg2_suc = NULL;
...
static PyObject * PyMSK_putslx(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  PyObject * memview__arg2_slx = NULL;
...
static PyObject * PyMSK_putsux(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  PyObject * memview__arg2_sux = NULL;
...
static PyObject * PyMSK_putsnx(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  PyObject * memview__arg2_sux = NULL;
...
static PyObject * PyMSK_putskcslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
...
static PyObject * PyMSK_putskxslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
...
static PyObject * PyMSK_putxcslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
...
static PyObject * PyMSK_putxxslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
...
static PyObject * PyMSK_putyslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
...
static PyObject * PyMSK_putslcslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
...
static PyObject * PyMSK_putsucslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
...
static PyObject * PyMSK_putslxslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
...
static PyObject * PyMSK_putsuxslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
...
static PyObject * PyMSK_putsnxslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
...
static PyObject * PyMSK_putbarxj(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_j;
...
static PyObject * PyMSK_putbarsj(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_j;
...
static PyObject * PyMSK_getpviolcon(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_num;
  ...
  if (Py_None != memview__arg4_viol)
  {
    ...
    if (buf__arg4_viol->strides != NULL && buf__arg4_viol->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getpviolvar(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_num;
...
static PyObject * PyMSK_getpviolbarvar(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_num;
...
static PyObject * PyMSK_getpviolcones(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_num;
...
static PyObject * PyMSK_getdviolcon(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_num;
...
static PyObject * PyMSK_getdviolvar(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_num;
...
static PyObject * PyMSK_getdviolbarvar(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_num;
...
static PyObject * PyMSK_getdviolcones(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_num;
...
static PyObject * PyMSK_getsolutioninfo(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  double _arg2_pobj;
  double _arg3_pviolcon;
  double _arg4_pviolvar;
  double _arg5_pviolbarvar;
  double _arg6_pviolcone;
  double _arg7_pviolitg;
  double _arg8_dobj;
  double _arg9_dviolcon;
  double _arg10_dviolvar;
  double _arg11_dviolbarvar;
  double _arg12_dviolcone;
  if (! PyArg_ParseTuple(_args,"i",&_arg1_whichsol)) goto ERROR;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyObject * PyMSK_getdualsolutionnorms(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  double _arg2_nrmy;
...
static PyObject * PyMSK_getprimalsolutionnorms(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  double _arg2_nrmxc;
  double _arg3_nrmxx;
  double _arg4_nrmbarx;
  if (! PyArg_ParseTuple(_args,"i",&_arg1_whichsol)) goto ERROR;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyObject * PyMSK_getsolutionslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  ...
  if (Py_None != memview__arg5_values)
  {
    ...
    if (buf__arg5_values->strides != NULL && buf__arg5_values->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getreducedcosts(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_first;
  ...
  if (Py_None != memview__arg4_redcosts)
  {
    ...
    if (buf__arg4_redcosts->strides != NULL && buf__arg4_redcosts->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getstrparam(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_getstrparamlen(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsparame _arg1_param;
  int _arg2_len;
...
static PyObject * PyMSK_gettasknamelen(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_len;
  {
...
static PyObject * PyMSK_gettaskname(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_getvartype(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_j;
...
static PyObject * PyMSK_getvartypelist(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  PyObject * memview__arg2_subj = NULL;
  ...
  if (Py_None != memview__arg3_vartype)
  {
    ...
    if (buf__arg3_vartype->strides != NULL && buf__arg3_vartype->strides[0] != sizeof(MSKvariabletypee))
    {
...
static PyObject * PyMSK_inputdata64(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_maxnumcon;
  int _arg2_maxnumvar;
  ...
  if (Py_None != memview__arg5_c)
  {
    ...
    if (buf__arg5_c->strides != NULL && buf__arg5_c->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg7_aptrb)
  {
    ...
    if (buf__arg7_aptrb->strides != NULL && buf__arg7_aptrb->strides[0] != sizeof(long long))
    {
  ...
  if (Py_None != memview__arg8_aptre)
  {
    ...
    if (buf__arg8_aptre->strides != NULL && buf__arg8_aptre->strides[0] != sizeof(long long))
    {
  ...
  if (Py_None != memview__arg9_asub)
  {
    ...
    if (buf__arg9_asub->strides != NULL && buf__arg9_asub->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg10_aval)
  {
    ...
    if (buf__arg10_aval->strides != NULL && buf__arg10_aval->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg11_bkc)
  {
    ...
    if (buf__arg11_bkc->strides != NULL && buf__arg11_bkc->strides[0] != sizeof(MSKboundkeye))
    {
  ...
  if (Py_None != memview__arg12_blc)
  {
    ...
    if (buf__arg12_blc->strides != NULL && buf__arg12_blc->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg13_buc)
  {
    ...
    if (buf__arg13_buc->strides != NULL && buf__arg13_buc->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg14_bkx)
  {
    ...
    if (buf__arg14_bkx->strides != NULL && buf__arg14_bkx->strides[0] != sizeof(MSKboundkeye))
    {
  ...
  if (Py_None != memview__arg15_blx)
  {
    ...
    if (buf__arg15_blx->strides != NULL && buf__arg15_blx->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg16_bux)
  {
    ...
    if (buf__arg16_bux->strides != NULL && buf__arg16_bux->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_isdouparname(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_parname = NULL;
  MSKdparame _arg2_param;
...
static PyObject * PyMSK_isintparname(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_parname = NULL;
  MSKiparame _arg2_param;
  if (! PyArg_ParseTuple(_args,"s",&str__arg1_parname)) goto ERROR;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyObject * PyMSK_isstrparname(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_parname = NULL;
  MSKsparame _arg2_param;
  if (! PyArg_ParseTuple(_args,"s",&str__arg1_parname)) goto ERROR;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyObject * PyMSK_linkfiletotaskstream(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKstreamtypee _arg1_whichstream;
...
static PyObject * PyMSK_primalrepair(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  ...
  if (Py_None != memview__arg1_wlc)
  {
    ...
    if (buf__arg1_wlc->strides != NULL && buf__arg1_wlc->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg2_wuc)
  {
    ...
    if (buf__arg2_wuc->strides != NULL && buf__arg2_wuc->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg3_wlx)
  {
    ...
    if (buf__arg3_wlx->strides != NULL && buf__arg3_wlx->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg4_wux)
  {
    ...
    if (buf__arg4_wux->strides != NULL && buf__arg4_wux->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_toconic(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyObject * PyMSK_optimizetrm(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKrescodee _arg1_trmcode;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyObject * PyMSK_commitchanges(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyObject * PyMSK_getatruncatetol(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  ...
  if (Py_None != memview__arg1_tolzero)
  {
    ...
    if (buf__arg1_tolzero->strides != NULL && buf__arg1_tolzero->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_putatruncatetol(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_putaij(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
  int _arg2_j;
...
static PyObject * PyMSK_putaijlist64(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_num;
  PyObject * memview__arg2_subi = NULL;
  ...
  if (Py_None != memview__arg4_valij)
  {
    ...
    if (buf__arg4_valij->strides != NULL && buf__arg4_valij->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_putacol(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_j;
  int _arg2_nzj;
...
static PyObject * PyMSK_putarow(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
  int _arg2_nzi;
...
static PyObject * PyMSK_putarowslice64(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_first;
  int _arg2_last;
  ...
  if (Py_None != memview__arg3_ptrb)
  {
    ...
    if (buf__arg3_ptrb->strides != NULL && buf__arg3_ptrb->strides[0] != sizeof(long long))
    {
  ...
  if (Py_None != memview__arg4_ptre)
  {
    ...
    if (buf__arg4_ptre->strides != NULL && buf__arg4_ptre->strides[0] != sizeof(long long))
    {
  ...
  if (Py_None != memview__arg5_asub)
  {
    ...
    if (buf__arg5_asub->strides != NULL && buf__arg5_asub->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg6_aval)
  {
    ...
    if (buf__arg6_aval->strides != NULL && buf__arg6_aval->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_putarowlist64(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  ...
  if (Py_None != memview__arg2_sub)
  {
    ...
    if (buf__arg2_sub->strides != NULL && buf__arg2_sub->strides[0] != sizeof(int))
    {
...
static PyObject * PyMSK_putacolslice64(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_first;
  int _arg2_last;
...
static PyObject * PyMSK_putacollist64(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  PyObject * memview__arg2_sub = NULL;
...
static PyObject * PyMSK_putbaraij(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
  int _arg2_j;
  ...
  if (Py_None != memview__arg4_sub)
  {
    ...
    if (buf__arg4_sub->strides != NULL && buf__arg4_sub->strides[0] != sizeof(long long))
    {
  ...
  if (Py_None != memview__arg5_weights)
  {
    ...
    if (buf__arg5_weights->strides != NULL && buf__arg5_weights->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_putbaraijlist(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  PyObject * memview__arg2_subi = NULL;
  ...
  if (Py_None != memview__arg4_alphaptrb)
  {
    ...
    if (buf__arg4_alphaptrb->strides != NULL && buf__arg4_alphaptrb->strides[0] != sizeof(long long))
    {
  ...
  if (Py_None != memview__arg5_alphaptre)
  {
    ...
    if (buf__arg5_alphaptre->strides != NULL && buf__arg5_alphaptre->strides[0] != sizeof(long long))
    {
  ...
  if (Py_None != memview__arg6_matidx)
  {
    ...
    if (buf__arg6_matidx->strides != NULL && buf__arg6_matidx->strides[0] != sizeof(long long))
    {
  ...
  if (Py_None != memview__arg7_weights)
  {
    ...
    if (buf__arg7_weights->strides != NULL && buf__arg7_weights->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_putbararowlist(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  PyObject * memview__arg2_subi = NULL;
  ...
  if (Py_None != memview__arg5_subj)
  {
    ...
    if (buf__arg5_subj->strides != NULL && buf__arg5_subj->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg6_nummat)
  {
    ...
    if (buf__arg6_nummat->strides != NULL && buf__arg6_nummat->strides[0] != sizeof(long long))
    {
  ...
  if (Py_None != memview__arg7_matidx)
  {
    ...
    if (buf__arg7_matidx->strides != NULL && buf__arg7_matidx->strides[0] != sizeof(long long))
    {
  ...
  if (Py_None != memview__arg8_weights)
  {
    ...
    if (buf__arg8_weights->strides != NULL && buf__arg8_weights->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getnumbarcnz(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_nz;
  {
...
static PyObject * PyMSK_getnumbaranz(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_nz;
  {
...
static PyObject * PyMSK_getbarcsparsity(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_maxnumnz;
  long long _arg2_numnz;
  ...
  if (Py_None != memview__arg3_idxj)
  {
    ...
    if (buf__arg3_idxj->strides != NULL && buf__arg3_idxj->strides[0] != sizeof(long long))
    {
...
static PyObject * PyMSK_getbarasparsity(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_maxnumnz;
  long long _arg2_numnz;
  ...
  if (Py_None != memview__arg3_idxij)
  {
    ...
    if (buf__arg3_idxij->strides != NULL && buf__arg3_idxij->strides[0] != sizeof(long long))
    {
...
static PyObject * PyMSK_getbarcidxinfo(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_idx;
  long long _arg2_num;
...
static PyObject * PyMSK_getbarcidxj(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_idx;
  int _arg2_j;
...
static PyObject * PyMSK_getbarcidx(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_idx;
  ...
  if (Py_None != memview__arg5_sub)
  {
    ...
    if (buf__arg5_sub->strides != NULL && buf__arg5_sub->strides[0] != sizeof(long long))
    {
  ...
  if (Py_None != memview__arg6_weights)
  {
    ...
    if (buf__arg6_weights->strides != NULL && buf__arg6_weights->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getbaraidxinfo(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_idx;
  long long _arg2_num;
...
static PyObject * PyMSK_getbaraidxij(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_idx;
  int _arg2_i;
...
static PyObject * PyMSK_getbaraidx(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_idx;
  long long _arg2_maxnum;
  ...
  if (Py_None != memview__arg6_sub)
  {
    ...
    if (buf__arg6_sub->strides != NULL && buf__arg6_sub->strides[0] != sizeof(long long))
    {
...
static PyObject * PyMSK_getnumbarcblocktriplets(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_num;
  {
...
static PyObject * PyMSK_putbarcblocktriplet(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_num;
  PyObject * memview__arg2_subj = NULL;
  ...
  if (Py_None != memview__arg3_subk)
  {
    ...
    if (buf__arg3_subk->strides != NULL && buf__arg3_subk->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg4_subl)
  {
    ...
    if (buf__arg4_subl->strides != NULL && buf__arg4_subl->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg5_valjkl)
  {
    ...
    if (buf__arg5_valjkl->strides != NULL && buf__arg5_valjkl->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getbarcblocktriplet(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  ...
  if (Py_None != memview__arg4_subk)
  {
    ...
    if (buf__arg4_subk->strides != NULL && buf__arg4_subk->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg5_subl)
  {
    ...
    if (buf__arg5_subl->strides != NULL && buf__arg5_subl->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg6_valjkl)
  {
    ...
    if (buf__arg6_valjkl->strides != NULL && buf__arg6_valjkl->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_putbarablocktriplet(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_num;
  PyObject * memview__arg2_subi = NULL;
  ...
  if (Py_None != memview__arg6_valijkl)
  {
    ...
    if (buf__arg6_valijkl->strides != NULL && buf__arg6_valijkl->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_getnumbarablocktriplets(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_num;
  {
...
static PyObject * PyMSK_getbarablocktriplet(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_maxnum;
  long long _arg2_num;
  ...
  if (Py_None != memview__arg4_subj)
  {
    ...
    if (buf__arg4_subj->strides != NULL && buf__arg4_subj->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg5_subk)
  {
    ...
    if (buf__arg5_subk->strides != NULL && buf__arg5_subk->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg6_subl)
  {
    ...
    if (buf__arg6_subl->strides != NULL && buf__arg6_subl->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg7_valijkl)
  {
    ...
    if (buf__arg7_valijkl->strides != NULL && buf__arg7_valijkl->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_putconbound(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
...
static PyObject * PyMSK_putconboundlist(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  PyObject * memview__arg2_sub = NULL;
  ...
  if (Py_None != memview__arg3_bkc)
  {
    ...
    if (buf__arg3_bkc->strides != NULL && buf__arg3_bkc->strides[0] != sizeof(MSKboundkeye))
    {
  ...
  if (Py_None != memview__arg4_blc)
  {
    ...
    if (buf__arg4_blc->strides != NULL && buf__arg4_blc->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg5_buc)
  {
    ...
    if (buf__arg5_buc->strides != NULL && buf__arg5_buc->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_putconboundlistconst(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  PyObject * memview__arg2_sub = NULL;
...
static PyObject * PyMSK_putconboundslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_first;
  int _arg2_last;
...
static PyObject * PyMSK_putconboundsliceconst(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_first;
  int _arg2_last;
...
static PyObject * PyMSK_putvarbound(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_j;
...
static PyObject * PyMSK_putvarboundlist(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  PyObject * memview__arg2_sub = NULL;
  ...
  if (Py_None != memview__arg3_bkx)
  {
    ...
    if (buf__arg3_bkx->strides != NULL && buf__arg3_bkx->strides[0] != sizeof(MSKboundkeye))
    {
  ...
  if (Py_None != memview__arg4_blx)
  {
    ...
    if (buf__arg4_blx->strides != NULL && buf__arg4_blx->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg5_bux)
  {
    ...
    if (buf__arg5_bux->strides != NULL && buf__arg5_bux->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_putvarboundlistconst(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  PyObject * memview__arg2_sub = NULL;
...
static PyObject * PyMSK_putvarboundslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_first;
  int _arg2_last;
...
static PyObject * PyMSK_putvarboundsliceconst(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_first;
  int _arg2_last;
...
static PyObject * PyMSK_putcfix(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  double _arg1_cfix;
...
static PyObject * PyMSK_putcj(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_j;
  double _arg2_cj;
...
static PyObject * PyMSK_putobjsense(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_getobjsense(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKobjsensee _arg1_sense;
  {
...
static PyObject * PyMSK_putclist(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  PyObject * memview__arg2_subj = NULL;
  ...
  if (Py_None != memview__arg3_val)
  {
    ...
    if (buf__arg3_val->strides != NULL && buf__arg3_val->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_putcslice(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_first;
  int _arg2_last;
  ...
  if (Py_None != memview__arg3_slice)
  {
    ...
    if (buf__arg3_slice->strides != NULL && buf__arg3_slice->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_putbarcj(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_j;
  long long _arg2_num;
  ...
  if (Py_None != memview__arg3_sub)
  {
    ...
    buf__arg3_sub = PyMemoryView_GET_BUFFER(memview__arg3_sub);
    if (buf__arg3_sub->strides != NULL && buf__arg3_sub->strides[0] != sizeof(long long))
    {
        PyErr_SetString(PyExc_TypeError,"Expected a continuous memoryview object for argument _arg3_sub");
        goto ERROR;
  ...
  if (Py_None != memview__arg4_weights)
  {
    ...
    if (buf__arg4_weights->strides != NULL && buf__arg4_weights->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_putcone(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_k;
  MSKconetypee _arg2_ct;
...
static PyObject * PyMSK_appendsparsesymmat(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_dim;
  long long _arg2_nz;
  ...
  if (Py_None != memview__arg5_valij)
  {
    ...
    if (buf__arg5_valij->strides != NULL && buf__arg5_valij->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_appendsparsesymmatlist(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  ...
  if (Py_None != memview__arg2_dims)
  {
    ...
    if (buf__arg2_dims->strides != NULL && buf__arg2_dims->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg3_nz)
  {
    ...
    if (buf__arg3_nz->strides != NULL && buf__arg3_nz->strides[0] != sizeof(long long))
    {
  ...
  if (Py_None != memview__arg4_subi)
  {
    ...
    if (buf__arg4_subi->strides != NULL && buf__arg4_subi->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg6_valij)
  {
    ...
    if (buf__arg6_valij->strides != NULL && buf__arg6_valij->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg7_idx)
  {
    ...
    if (buf__arg7_idx->strides != NULL && buf__arg7_idx->strides[0] != sizeof(long long))
    {
...
static PyObject * PyMSK_getsymmatinfo(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_idx;
  int _arg2_dim;
  long long _arg3_nz;
  MSKsymmattypee _arg4_type;
  if (! PyArg_ParseTuple(_args,"L",&_arg1_idx)) goto ERROR;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyObject * PyMSK_getnumsymmat(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_num;
  {
...
static PyObject * PyMSK_getsparsesymmat(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_idx;
...
static PyObject * PyMSK_putdouparam(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKdparame _arg1_param;
  double _arg2_parvalue;
...
static PyObject * PyMSK_putintparam(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKiparame _arg1_param;
  int _arg2_parvalue;
...
static PyObject * PyMSK_putmaxnumcon(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_maxnumcon;
...
static PyObject * PyMSK_putmaxnumcone(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_getmaxnumcone(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_maxnumcone;
  {
...
static PyObject * PyMSK_putmaxnumvar(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_maxnumvar;
...
static PyObject * PyMSK_putmaxnumbarvar(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_maxnumbarvar;
...
static PyObject * PyMSK_putmaxnumanz(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_maxnumanz;
...
static PyObject * PyMSK_putmaxnumqnz(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_getmaxnumqnz64(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_maxnumqnz;
  {
...
static PyObject * PyMSK_putnadouparam(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_putnaintparam(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_paramname = NULL;
  int _arg2_parvalue;
...
static PyObject * PyMSK_putnastrparam(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_paramname = NULL;
...
static PyObject * PyMSK_putobjname(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_putparam(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_parname = NULL;
  char * str__arg2_parvalue = NULL;
...
static PyObject * PyMSK_putqcon(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_numqcnz;
  ...
  if (Py_None != memview__arg2_qcsubk)
  {
    ...
    if (buf__arg2_qcsubk->strides != NULL && buf__arg2_qcsubk->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg3_qcsubi)
  {
    ...
    if (buf__arg3_qcsubi->strides != NULL && buf__arg3_qcsubi->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg4_qcsubj)
  {
    ...
    if (buf__arg4_qcsubj->strides != NULL && buf__arg4_qcsubj->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg5_qcval)
  {
    ...
    if (buf__arg5_qcval->strides != NULL && buf__arg5_qcval->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_putqconk(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_k;
  int _arg2_numqcnz;
...
static PyObject * PyMSK_putqobj(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_numqonz;
  ...
  if (Py_None != memview__arg2_qosubi)
  {
    ...
    if (buf__arg2_qosubi->strides != NULL && buf__arg2_qosubi->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg3_qosubj)
  {
    ...
    if (buf__arg3_qosubj->strides != NULL && buf__arg3_qosubj->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg4_qoval)
  {
    ...
    if (buf__arg4_qoval->strides != NULL && buf__arg4_qoval->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_putqobjij(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
  int _arg2_j;
...
static PyObject * PyMSK_putsolution(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  PyObject * memview__arg2_skc = NULL;
  ...
  if (Py_None != memview__arg3_skx)
  {
    ...
    if (buf__arg3_skx->strides != NULL && buf__arg3_skx->strides[0] != sizeof(MSKstakeye))
    {
  ...
  if (Py_None != memview__arg4_skn)
  {
    ...
    if (buf__arg4_skn->strides != NULL && buf__arg4_skn->strides[0] != sizeof(MSKstakeye))
    {
  ...
  if (Py_None != memview__arg5_xc)
  {
    ...
    if (buf__arg5_xc->strides != NULL && buf__arg5_xc->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg6_xx)
  {
    ...
    if (buf__arg6_xx->strides != NULL && buf__arg6_xx->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg7_y)
  {
    ...
    if (buf__arg7_y->strides != NULL && buf__arg7_y->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg8_slc)
  {
    ...
    if (buf__arg8_slc->strides != NULL && buf__arg8_slc->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg9_suc)
  {
    ...
    if (buf__arg9_suc->strides != NULL && buf__arg9_suc->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg10_slx)
  {
    ...
    if (buf__arg10_slx->strides != NULL && buf__arg10_slx->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg11_sux)
  {
    ...
    if (buf__arg11_sux->strides != NULL && buf__arg11_sux->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg12_snx)
  {
    ...
    if (buf__arg12_snx->strides != NULL && buf__arg12_snx->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_putconsolutioni(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
  MSKsoltypee _arg2_whichsol;
...
static PyObject * PyMSK_putvarsolutionj(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_j;
  MSKsoltypee _arg2_whichsol;
...
static PyObject * PyMSK_putsolutionyi(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_i;
  MSKsoltypee _arg2_whichsol;
...
static PyObject * PyMSK_putstrparam(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsparame _arg1_param;
  char * str__arg2_parvalue = NULL;
...
static PyObject * PyMSK_puttaskname(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_putvartype(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_j;
  MSKvariabletypee _arg2_vartype;
...
static PyObject * PyMSK_putvartypelist(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_num;
  PyObject * memview__arg2_subj = NULL;
...
static PyObject * PyMSK_readdataformat(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_readdataautoformat(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_filename = NULL;
...
static PyObject * PyMSK_readparamfile(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_filename = NULL;
  if (! PyArg_ParseTuple(_args,"s",&str__arg1_filename)) goto ERROR;
...
static PyObject * PyMSK_readsolution(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  char * str__arg2_filename = NULL;
...
static PyObject * PyMSK_readsummary(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKstreamtypee _arg1_whichstream;
  if (! PyArg_ParseTuple(_args,"i",&_arg1_whichstream)) goto ERROR;
...
static PyObject * PyMSK_resizetask(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_maxnumcon;
  int _arg2_maxnumvar;
...
static PyObject * PyMSK_checkmemtask(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_getmemusagetask(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  long long _arg1_meminuse;
  long long _arg2_maxmemuse;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyObject * PyMSK_setdefaults(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyObject * PyMSK_solutiondef(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  int _arg2_isdef;
...
static PyObject * PyMSK_deletesolution(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  if (! PyArg_ParseTuple(_args,"i",&_arg1_whichsol)) goto ERROR;
...
static PyObject * PyMSK_onesolutionsummary(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKstreamtypee _arg1_whichstream;
  MSKsoltypee _arg2_whichsol;
...
static PyObject * PyMSK_solutionsummary(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKstreamtypee _arg1_whichstream;
  if (! PyArg_ParseTuple(_args,"i",&_arg1_whichstream)) goto ERROR;
...
static PyObject * PyMSK_updatesolutioninfo(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  if (! PyArg_ParseTuple(_args,"i",&_arg1_whichsol)) goto ERROR;
...
static PyObject * PyMSK_optimizersummary(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKstreamtypee _arg1_whichstream;
  if (! PyArg_ParseTuple(_args,"i",&_arg1_whichstream)) goto ERROR;
...
static PyObject * PyMSK_strtoconetype(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_str = NULL;
  MSKconetypee _arg2_conetype;
...
static PyObject * PyMSK_strtosk(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_str = NULL;
  MSKstakeye _arg2_sk;
...
static PyObject * PyMSK_writedata(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_filename = NULL;
  if (! PyArg_ParseTuple(_args,"s",&str__arg1_filename)) goto ERROR;
...
static PyObject * PyMSK_writetask(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_filename = NULL;
  if (! PyArg_ParseTuple(_args,"s",&str__arg1_filename)) goto ERROR;
...
static PyObject * PyMSK_readtask(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_filename = NULL;
  if (! PyArg_ParseTuple(_args,"s",&str__arg1_filename)) goto ERROR;
...
static PyObject * PyMSK_readopfstring(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_readlpstring(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_data = NULL;
  if (! PyArg_ParseTuple(_args,"s",&str__arg1_data)) goto ERROR;
...
static PyObject * PyMSK_readjsonstring(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_data = NULL;
  if (! PyArg_ParseTuple(_args,"s",&str__arg1_data)) goto ERROR;
...
static PyObject * PyMSK_readptfstring(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_data = NULL;
  if (! PyArg_ParseTuple(_args,"s",&str__arg1_data)) goto ERROR;
...
static PyObject * PyMSK_writeparamfile(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_filename = NULL;
  if (! PyArg_ParseTuple(_args,"s",&str__arg1_filename)) goto ERROR;
...
static PyObject * PyMSK_getinfeasiblesubproblem(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  MSKtask_t _arg2_inftask;
...
static PyObject * PyMSK_writesolution(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKsoltypee _arg1_whichsol;
  char * str__arg2_filename = NULL;
...
static PyObject * PyMSK_writejsonsol(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_filename = NULL;
  if (! PyArg_ParseTuple(_args,"s",&str__arg1_filename)) goto ERROR;
...
static PyObject * PyMSK_primalsensitivity(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_numi;
  PyObject * memview__arg2_subi = NULL;
  ...
  if (Py_None != memview__arg3_marki)
  {
    ...
    if (buf__arg3_marki->strides != NULL && buf__arg3_marki->strides[0] != sizeof(MSKmarke))
    {
  ...
  if (Py_None != memview__arg6_markj)
  {
    ...
    if (buf__arg6_markj->strides != NULL && buf__arg6_markj->strides[0] != sizeof(MSKmarke))
    {
  ...
  if (Py_None != memview__arg7_leftpricei)
  {
    ...
    if (buf__arg7_leftpricei->strides != NULL && buf__arg7_leftpricei->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg8_rightpricei)
  {
    ...
    if (buf__arg8_rightpricei->strides != NULL && buf__arg8_rightpricei->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg9_leftrangei)
  {
    ...
    if (buf__arg9_leftrangei->strides != NULL && buf__arg9_leftrangei->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg10_rightrangei)
  {
    ...
    if (buf__arg10_rightrangei->strides != NULL && buf__arg10_rightrangei->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg11_leftpricej)
  {
    ...
    if (buf__arg11_leftpricej->strides != NULL && buf__arg11_leftpricej->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg12_rightpricej)
  {
    ...
    if (buf__arg12_rightpricej->strides != NULL && buf__arg12_rightpricej->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg13_leftrangej)
  {
    ...
    if (buf__arg13_leftrangej->strides != NULL && buf__arg13_leftrangej->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg14_rightrangej)
  {
    ...
    if (buf__arg14_rightrangej->strides != NULL && buf__arg14_rightrangej->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_sensitivityreport(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKstreamtypee _arg1_whichstream;
  if (! PyArg_ParseTuple(_args,"i",&_arg1_whichstream)) goto ERROR;
...
static PyObject * PyMSK_dualsensitivity(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_numj;
  PyObject * memview__arg2_subj = NULL;
  ...
  if (Py_None != memview__arg3_leftpricej)
  {
    ...
    if (buf__arg3_leftpricej->strides != NULL && buf__arg3_leftpricej->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg4_rightpricej)
  {
    ...
    if (buf__arg4_rightpricej->strides != NULL && buf__arg4_rightpricej->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg5_leftrangej)
  {
    ...
    if (buf__arg5_leftrangej->strides != NULL && buf__arg5_leftrangej->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg6_rightrangej)
  {
    ...
    if (buf__arg6_rightrangej->strides != NULL && buf__arg6_rightrangej->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_optimizermt(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_server = NULL;
  char * str__arg2_port = NULL;
  MSKrescodee _arg3_trmcode;
...
static PyObject * PyMSK_asyncoptimize(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_server = NULL;
  char * str__arg2_port = NULL;
...
static PyObject * PyMSK_asyncstop(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_server = NULL;
  char * str__arg2_port = NULL;
...
static PyObject * PyMSK_asyncpoll(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_server = NULL;
  char * str__arg2_port = NULL;
  char * str__arg3_token = NULL;
  int _arg4_respavailable;
  MSKrescodee _arg5_resp;
  MSKrescodee _arg6_trm;
  if (! PyArg_ParseTuple(_args,"sss",&str__arg1_server,&str__arg2_port,&str__arg3_token)) goto ERROR;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyObject * PyMSK_asyncgetresult(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_server = NULL;
  char * str__arg2_port = NULL;
...
static PyObject * PyMSK_putoptserverhost(mosek_TaskObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  char * str__arg1_host = NULL;
  if (! PyArg_ParseTuple(_args,"s",&str__arg1_host)) goto ERROR;
  {
    Py_BEGIN_ALLOW_THREADS
    _r = MSK_putoptserverhost(self->ptr,str__arg1_host);
    Py_END_ALLOW_THREADS
    if (PyErr_Occurred()) goto ERROR;
    if (_r != MSK_RES_OK) goto RES_ERROR;
  }
...
static PyObject * PyMSK_checkoutlicense(mosek_EnvObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_checkinlicense(mosek_EnvObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKfeaturee _arg1_feature;
  if (! PyArg_ParseTuple(_args,"i",&_arg1_feature)) goto ERROR;
...
static PyObject * PyMSK_checkinall(mosek_EnvObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyObject * PyMSK_setupthreads(mosek_EnvObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_echointro(mosek_EnvObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_longver;
...
static PyObject * PyMSK_getcodedesc(PyObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_getversion(PyObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg0_major;
  int _arg1_minor;
...
static PyObject * PyMSK_linkfiletoenvstream(mosek_EnvObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKstreamtypee _arg1_whichstream;
  char * str__arg2_filename = NULL;
...
static PyObject * PyMSK_putlicensedebug(mosek_EnvObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_licdebug;
...
static PyObject * PyMSK_putlicensecode(mosek_EnvObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  ...
  if (Py_None != memview__arg1_code)
  {
    ...
    if (buf__arg1_code->strides != NULL && buf__arg1_code->strides[0] != sizeof(int))
    {
...
static PyObject * PyMSK_putlicensewait(mosek_EnvObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_licwait;
...
static PyObject * PyMSK_putlicensepath(mosek_EnvObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
...
static PyObject * PyMSK_axpy(mosek_EnvObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_n;
  double _arg2_alpha;
  ...
  if (Py_None != memview__arg3_x)
  {
    ...
    if (buf__arg3_x->strides != NULL && buf__arg3_x->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_dot(mosek_EnvObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  int _arg1_n;
  ...
  if (Py_None != memview__arg2_x)
  {
    ...
    if (buf__arg2_x->strides != NULL && buf__arg2_x->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg3_y)
  {
    ...
    if (buf__arg3_y->strides != NULL && buf__arg3_y->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_gemv(mosek_EnvObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  ...
  if (Py_None != memview__arg5_a)
  {
    ...
    if (buf__arg5_a->strides != NULL && buf__arg5_a->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg6_x)
  {
    ...
    if (buf__arg6_x->strides != NULL && buf__arg6_x->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg8_y)
  {
    ...
    if (buf__arg8_y->strides != NULL && buf__arg8_y->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_gemm(mosek_EnvObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKtransposee _arg1_transa;
  ...
  if (Py_None != memview__arg7_a)
  {
    ...
    if (buf__arg7_a->strides != NULL && buf__arg7_a->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg8_b)
  {
    ...
    if (buf__arg8_b->strides != NULL && buf__arg8_b->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg10_c)
  {
    ...
    if (buf__arg10_c->strides != NULL && buf__arg10_c->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_syrk(mosek_EnvObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKuploe _arg1_uplo;
  ...
  if (Py_None != memview__arg6_a)
  {
    ...
    if (buf__arg6_a->strides != NULL && buf__arg6_a->strides[0] != sizeof(double))
    {
  ...
  if (Py_None != memview__arg8_c)
  {
    ...
    if (buf__arg8_c->strides != NULL && buf__arg8_c->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_computesparsecholesky(mosek_EnvObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  ...
  if (Py_None != memview__arg5_anzc)
  {
    ...
    if (buf__arg5_anzc->strides != NULL && buf__arg5_anzc->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg6_aptrc)
  {
    ...
    if (buf__arg6_aptrc->strides != NULL && buf__arg6_aptrc->strides[0] != sizeof(long long))
    {
  ...
  if (Py_None != memview__arg7_asubc)
  {
    ...
    if (buf__arg7_asubc->strides != NULL && buf__arg7_asubc->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg8_avalc)
  {
    ...
    if (buf__arg8_avalc->strides != NULL && buf__arg8_avalc->strides[0] != sizeof(double))
    {
  ...
  for (_i__arg9_perm = 0; _i__arg9_perm < _arg4_n && !PyErr_Occurred(); ++_i__arg9_perm) {
    PyList_SET_ITEM(__arg9_perm,_i__arg9_perm,PyInt_FromLong(_arg9_perm[_i__arg9_perm])); /* 2 !!!! */
  }
  if (PyErr_Occurred()) goto ERROR;
  __arg10_diag = PyList_New(_arg4_n);
  for (_i__arg10_diag = 0; _i__arg10_diag < _arg4_n && !PyErr_Occurred(); ++_i__arg10_diag) {
    PyList_SET_ITEM(__arg10_diag,_i__arg10_diag,PyFloat_FromDouble(_arg10_diag[_i__arg10_diag])); /* 2 !!!! */
  }
  if (PyErr_Occurred()) goto ERROR;
  __arg11_lnzc = PyList_New(_arg4_n);
  for (_i__arg11_lnzc = 0; _i__arg11_lnzc < _arg4_n && !PyErr_Occurred(); ++_i__arg11_lnzc) {
    PyList_SET_ITEM(__arg11_lnzc,_i__arg11_lnzc,PyInt_FromLong(_arg11_lnzc[_i__arg11_lnzc])); /* 2 !!!! */
  }
  if (PyErr_Occurred()) goto ERROR;
  __arg12_lptrc = PyList_New(_arg4_n);
  for (_i__arg12_lptrc = 0; _i__arg12_lptrc < _arg4_n && !PyErr_Occurred(); ++_i__arg12_lptrc) {
    PyList_SET_ITEM(__arg12_lptrc,_i__arg12_lptrc,PyLong_FromLongLong(_arg12_lptrc[_i__arg12_lptrc])); /* 2 !!!! */
  }
  if (PyErr_Occurred()) goto ERROR;
  ...
  for (_i__arg14_lsubc = 0; _i__arg14_lsubc < _arg13_lensubnval && !PyErr_Occurred(); ++_i__arg14_lsubc) {
    PyList_SET_ITEM(__arg14_lsubc,_i__arg14_lsubc,PyInt_FromLong(_arg14_lsubc[_i__arg14_lsubc])); /* 2 !!!! */
  }
  if (PyErr_Occurred()) goto ERROR;
  ...
  for (_i__arg15_lvalc = 0; _i__arg15_lvalc < _arg13_lensubnval && !PyErr_Occurred(); ++_i__arg15_lvalc) {
    PyList_SET_ITEM(__arg15_lvalc,_i__arg15_lvalc,PyFloat_FromDouble(_arg15_lvalc[_i__arg15_lvalc])); /* 2 !!!! */
  }
  if (PyErr_Occurred()) goto ERROR;
...
static PyObject * PyMSK_sparsetriangularsolvedense(mosek_EnvObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  ...
  if (Py_None != memview__arg3_lnzc)
  {
    ...
    if (buf__arg3_lnzc->strides != NULL && buf__arg3_lnzc->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg4_lptrc)
  {
    ...
    if (buf__arg4_lptrc->strides != NULL && buf__arg4_lptrc->strides[0] != sizeof(long long))
    {
  ...
  if (Py_None != memview__arg6_lsubc)
  {
    ...
    if (buf__arg6_lsubc->strides != NULL && buf__arg6_lsubc->strides[0] != sizeof(int))
    {
  ...
  if (Py_None != memview__arg7_lvalc)
  {
    ...
    if (buf__arg7_lvalc->strides != NULL && buf__arg7_lvalc->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_potrf(mosek_EnvObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKuploe _arg1_uplo;
  int _arg2_n;
  ...
  if (Py_None != memview__arg3_a)
  {
    ...
    if (buf__arg3_a->strides != NULL && buf__arg3_a->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_syeig(mosek_EnvObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKuploe _arg1_uplo;
  int _arg2_n;
  ...
  if (Py_None != memview__arg4_w)
  {
    ...
    if (buf__arg4_w->strides != NULL && buf__arg4_w->strides[0] != sizeof(double))
    {
...
static PyObject * PyMSK_syevd(mosek_EnvObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  MSKuploe _arg1_uplo;
  int _arg2_n;
...
static PyObject * PyMSK_licensecleanup(PyObject * self, PyObject * _args)
{
  MSKrescodee _r = MSK_RES_OK;
  {
    Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef Task_methods[] = {
  ...
  { "putoptserverhost",(PyCFunction)PyMSK_putoptserverhost, METH_VARARGS, "putoptserverhost(_arg1_host)" },
