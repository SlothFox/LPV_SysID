...
std::shared_ptr< monty::ndarray< int,1 > > shape{};virtual void destroy();
static BaseExpression::t _new_BaseExpression(std::shared_ptr< monty::ndarray< int,1 > > _6762);
void _initialize(std::shared_ptr< monty::ndarray< int,1 > > _6762);
virtual /* override */ std::string toString() ;
virtual void printStack(monty::rc_ptr< ::mosek::fusion::WorkStack > _6763) ;
virtual void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6789,monty::rc_ptr< ::mosek::fusion::WorkStack > _6790,monty::rc_ptr< ::mosek::fusion::WorkStack > _6791) { throw monty::AbstractClassError("Call to abstract method"); }
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2BaseExpression__pick(std::shared_ptr< monty::ndarray< int,2 > > _6792) ;
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2Expression__pick(std::shared_ptr< monty::ndarray< int,2 > > _6792) { return __mosek_2fusion_2BaseExpression__pick(_6792); }
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2BaseExpression__pick(std::shared_ptr< monty::ndarray< int,1 > > _6793) ;
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2Expression__pick(std::shared_ptr< monty::ndarray< int,1 > > _6793) { return __mosek_2fusion_2BaseExpression__pick(_6793); }
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2BaseExpression__index(std::shared_ptr< monty::ndarray< int,1 > > _6796) ;
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2Expression__index(std::shared_ptr< monty::ndarray< int,1 > > _6796) { return __mosek_2fusion_2BaseExpression__index(_6796); }
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2BaseExpression__index(int _6799) ;
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2Expression__index(int _6799) { return __mosek_2fusion_2BaseExpression__index(_6799); }
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2BaseExpression__slice(std::shared_ptr< monty::ndarray< int,1 > > _6801,std::shared_ptr< monty::ndarray< int,1 > > _6802) ;
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2Expression__slice(std::shared_ptr< monty::ndarray< int,1 > > _6801,std::shared_ptr< monty::ndarray< int,1 > > _6802) { return __mosek_2fusion_2BaseExpression__slice(_6801,_6802); }
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2BaseExpression__slice(int _6803,int _6804) ;
virtual monty::rc_ptr< ::mosek::fusion::Expression > __mosek_2fusion_2Expression__slice(int _6803,int _6804) { return __mosek_2fusion_2BaseExpression__slice(_6803,_6804); }
virtual long long getSize() ;
virtual int getND() ;
virtual int getDim(int _6805) ;
virtual std::shared_ptr< monty::ndarray< int,1 > > getShape() ;
...
static ExprCompress::t _new_ExprCompress(monty::rc_ptr< ::mosek::fusion::Expression > _4289,double _4290);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _4289,double _4290);
static  void arg_sort(monty::rc_ptr< ::mosek::fusion::WorkStack > _4291,monty::rc_ptr< ::mosek::fusion::WorkStack > _4292,int _4293,int _4294,int _4295,int _4296,int _4297);
static  void merge_sort(int _4333,int _4334,int _4335,int _4336,int _4337,int _4338,std::shared_ptr< monty::ndarray< int,1 > > _4339,std::shared_ptr< monty::ndarray< long long,1 > > _4340);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _4363,monty::rc_ptr< ::mosek::fusion::WorkStack > _4364,monty::rc_ptr< ::mosek::fusion::WorkStack > _4365) ;
virtual /* override */ std::string toString() ;
}; // struct ExprCompress;
...
static ExprConst::t _new_ExprConst(std::shared_ptr< monty::ndarray< int,1 > > _4452,std::shared_ptr< monty::ndarray< long long,1 > > _4453,std::shared_ptr< monty::ndarray< double,1 > > _4454);
void _initialize(std::shared_ptr< monty::ndarray< int,1 > > _4452,std::shared_ptr< monty::ndarray< long long,1 > > _4453,std::shared_ptr< monty::ndarray< double,1 > > _4454);
static ExprConst::t _new_ExprConst(std::shared_ptr< monty::ndarray< int,1 > > _4455,std::shared_ptr< monty::ndarray< long long,1 > > _4456,double _4457);
void _initialize(std::shared_ptr< monty::ndarray< int,1 > > _4455,std::shared_ptr< monty::ndarray< long long,1 > > _4456,double _4457);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _4460,monty::rc_ptr< ::mosek::fusion::WorkStack > _4461,monty::rc_ptr< ::mosek::fusion::WorkStack > _4462) ;
static  void validate(std::shared_ptr< monty::ndarray< int,1 > > _4481,std::shared_ptr< monty::ndarray< double,1 > > _4482,std::shared_ptr< monty::ndarray< long long,1 > > _4483);
virtual /* override */ std::string toString() ;
}; // struct ExprConst;
...
static ExprPick::t _new_ExprPick(monty::rc_ptr< ::mosek::fusion::Expression > _4487,std::shared_ptr< monty::ndarray< int,2 > > _4488);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _4487,std::shared_ptr< monty::ndarray< int,2 > > _4488);
static ExprPick::t _new_ExprPick(monty::rc_ptr< ::mosek::fusion::Expression > _4500,std::shared_ptr< monty::ndarray< long long,1 > > _4501);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _4500,std::shared_ptr< monty::ndarray< long long,1 > > _4501);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _4506,monty::rc_ptr< ::mosek::fusion::WorkStack > _4507,monty::rc_ptr< ::mosek::fusion::WorkStack > _4508) ;
virtual /* override */ std::string toString() ;
}; // struct ExprPick;
...
static ExprSlice::t _new_ExprSlice(monty::rc_ptr< ::mosek::fusion::Expression > _4573,std::shared_ptr< monty::ndarray< int,1 > > _4574,std::shared_ptr< monty::ndarray< int,1 > > _4575);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _4573,std::shared_ptr< monty::ndarray< int,1 > > _4574,std::shared_ptr< monty::ndarray< int,1 > > _4575);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _4576,monty::rc_ptr< ::mosek::fusion::WorkStack > _4577,monty::rc_ptr< ::mosek::fusion::WorkStack > _4578) ;
static  std::shared_ptr< monty::ndarray< int,1 > > makeShape(std::shared_ptr< monty::ndarray< int,1 > > _4643,std::shared_ptr< monty::ndarray< int,1 > > _4644,std::shared_ptr< monty::ndarray< int,1 > > _4645);
virtual /* override */ std::string toString() ;
}; // struct ExprSlice;
...
static ExprPermuteDims::t _new_ExprPermuteDims(std::shared_ptr< monty::ndarray< int,1 > > _4650,monty::rc_ptr< ::mosek::fusion::Expression > _4651);
void _initialize(std::shared_ptr< monty::ndarray< int,1 > > _4650,monty::rc_ptr< ::mosek::fusion::Expression > _4651);
static ExprPermuteDims::t _new_ExprPermuteDims(std::shared_ptr< monty::ndarray< int,1 > > _4657,monty::rc_ptr< ::mosek::fusion::Expression > _4658,int _4659);
void _initialize(std::shared_ptr< monty::ndarray< int,1 > > _4657,monty::rc_ptr< ::mosek::fusion::Expression > _4658,int _4659);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _4660,monty::rc_ptr< ::mosek::fusion::WorkStack > _4661,monty::rc_ptr< ::mosek::fusion::WorkStack > _4662) ;
static  std::shared_ptr< monty::ndarray< int,1 > > computeshape(std::shared_ptr< monty::ndarray< int,1 > > _4716,std::shared_ptr< monty::ndarray< int,1 > > _4717);
...
monty::rc_ptr< ::mosek::fusion::Expression > expr{};virtual void destroy();
static ExprTranspose::t _new_ExprTranspose(monty::rc_ptr< ::mosek::fusion::Expression > _4719);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _4719);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _4720,monty::rc_ptr< ::mosek::fusion::WorkStack > _4721,monty::rc_ptr< ::mosek::fusion::WorkStack > _4722) ;
virtual /* override */ std::string toString() ;
static  std::shared_ptr< monty::ndarray< int,1 > > transposeShape(std::shared_ptr< monty::ndarray< int,1 > > _4775);
...
static ExprRepeat::t _new_ExprRepeat(monty::rc_ptr< ::mosek::fusion::Expression > _4776,int _4777,int _4778);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _4776,int _4777,int _4778);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _4779,monty::rc_ptr< ::mosek::fusion::WorkStack > _4780,monty::rc_ptr< ::mosek::fusion::WorkStack > _4781) ;
static  std::shared_ptr< monty::ndarray< int,1 > > getshape(monty::rc_ptr< ::mosek::fusion::Expression > _4846,int _4847,int _4848);
virtual /* override */ std::string toString() ;
}; // struct ExprRepeat;
...
static ExprStack::t _new_ExprStack(std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Expression >,1 > > _4853,int _4854);
void _initialize(std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Expression >,1 > > _4853,int _4854);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _4856,monty::rc_ptr< ::mosek::fusion::WorkStack > _4857,monty::rc_ptr< ::mosek::fusion::WorkStack > _4858) ;
static  std::shared_ptr< monty::ndarray< int,1 > > getshape(std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Expression >,1 > > _5002,int _5003);
virtual /* override */ std::string toString() ;
}; // struct ExprStack;
...
static ExprInner::t _new_ExprInner(monty::rc_ptr< ::mosek::fusion::Expression > _5017,std::shared_ptr< monty::ndarray< long long,1 > > _5018,std::shared_ptr< monty::ndarray< double,1 > > _5019);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _5017,std::shared_ptr< monty::ndarray< long long,1 > > _5018,std::shared_ptr< monty::ndarray< double,1 > > _5019);
static ExprInner::t _new_ExprInner(monty::rc_ptr< ::mosek::fusion::Expression > _5025,std::shared_ptr< monty::ndarray< double,1 > > _5026);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _5025,std::shared_ptr< monty::ndarray< double,1 > > _5026);
static ExprInner::t _new_ExprInner(monty::rc_ptr< ::mosek::fusion::Expression > _5028,std::shared_ptr< monty::ndarray< int,2 > > _5029,std::shared_ptr< monty::ndarray< double,1 > > _5030);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _5028,std::shared_ptr< monty::ndarray< int,2 > > _5029,std::shared_ptr< monty::ndarray< double,1 > > _5030);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _5031,monty::rc_ptr< ::mosek::fusion::WorkStack > _5032,monty::rc_ptr< ::mosek::fusion::WorkStack > _5033) ;
static  std::shared_ptr< monty::ndarray< long long,1 > > range(int _5077);
static  std::shared_ptr< monty::ndarray< long long,1 > > convert(std::shared_ptr< monty::ndarray< int,1 > > _5079,std::shared_ptr< monty::ndarray< int,2 > > _5080);
virtual /* override */ std::string toString() ;
}; // struct ExprInner;
...
static ExprMulDiagRight::t _new_ExprMulDiagRight(int _5087,int _5088,std::shared_ptr< monty::ndarray< int,1 > > _5089,std::shared_ptr< monty::ndarray< int,1 > > _5090,std::shared_ptr< monty::ndarray< double,1 > > _5091,monty::rc_ptr< ::mosek::fusion::Expression > _5092,int _5093);
void _initialize(int _5087,int _5088,std::shared_ptr< monty::ndarray< int,1 > > _5089,std::shared_ptr< monty::ndarray< int,1 > > _5090,std::shared_ptr< monty::ndarray< double,1 > > _5091,monty::rc_ptr< ::mosek::fusion::Expression > _5092,int _5093);
static ExprMulDiagRight::t _new_ExprMulDiagRight(int _5094,int _5095,std::shared_ptr< monty::ndarray< int,1 > > _5096,std::shared_ptr< monty::ndarray< int,1 > > _5097,std::shared_ptr< monty::ndarray< double,1 > > _5098,monty::rc_ptr< ::mosek::fusion::Expression > _5099);
void _initialize(int _5094,int _5095,std::shared_ptr< monty::ndarray< int,1 > > _5096,std::shared_ptr< monty::ndarray< int,1 > > _5097,std::shared_ptr< monty::ndarray< double,1 > > _5098,monty::rc_ptr< ::mosek::fusion::Expression > _5099);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _5100,monty::rc_ptr< ::mosek::fusion::WorkStack > _5101,monty::rc_ptr< ::mosek::fusion::WorkStack > _5102) ;
static  int validate(int _5181,int _5182,std::shared_ptr< monty::ndarray< int,1 > > _5183,std::shared_ptr< monty::ndarray< int,1 > > _5184,std::shared_ptr< monty::ndarray< double,1 > > _5185,monty::rc_ptr< ::mosek::fusion::Expression > _5186);
virtual /* override */ std::string toString() ;
...
monty::rc_ptr< ::mosek::fusion::Expression > expr{};std::shared_ptr< monty::ndarray< double,1 > > mval{};std::shared_ptr< monty::ndarray< int,1 > > msubj{};std::shared_ptr< monty::ndarray< int,1 > > msubi{};int mdim1{};int mdim0{};virtual void destroy();
static ExprMulDiagLeft::t _new_ExprMulDiagLeft(int _5195,int _5196,std::shared_ptr< monty::ndarray< int,1 > > _5197,std::shared_ptr< monty::ndarray< int,1 > > _5198,std::shared_ptr< monty::ndarray< double,1 > > _5199,monty::rc_ptr< ::mosek::fusion::Expression > _5200,int _5201);
void _initialize(int _5195,int _5196,std::shared_ptr< monty::ndarray< int,1 > > _5197,std::shared_ptr< monty::ndarray< int,1 > > _5198,std::shared_ptr< monty::ndarray< double,1 > > _5199,monty::rc_ptr< ::mosek::fusion::Expression > _5200,int _5201);
static ExprMulDiagLeft::t _new_ExprMulDiagLeft(int _5202,int _5203,std::shared_ptr< monty::ndarray< int,1 > > _5204,std::shared_ptr< monty::ndarray< int,1 > > _5205,std::shared_ptr< monty::ndarray< double,1 > > _5206,monty::rc_ptr< ::mosek::fusion::Expression > _5207);
void _initialize(int _5202,int _5203,std::shared_ptr< monty::ndarray< int,1 > > _5204,std::shared_ptr< monty::ndarray< int,1 > > _5205,std::shared_ptr< monty::ndarray< double,1 > > _5206,monty::rc_ptr< ::mosek::fusion::Expression > _5207);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _5208,monty::rc_ptr< ::mosek::fusion::WorkStack > _5209,monty::rc_ptr< ::mosek::fusion::WorkStack > _5210) ;
static  int validate(int _5308,int _5309,std::shared_ptr< monty::ndarray< int,1 > > _5310,std::shared_ptr< monty::ndarray< int,1 > > _5311,std::shared_ptr< monty::ndarray< double,1 > > _5312,monty::rc_ptr< ::mosek::fusion::Expression > _5313);
virtual /* override */ std::string toString() ;
...
static ExprMulElement::t _new_ExprMulElement(std::shared_ptr< monty::ndarray< double,1 > > _5322,std::shared_ptr< monty::ndarray< long long,1 > > _5323,monty::rc_ptr< ::mosek::fusion::Expression > _5324);
void _initialize(std::shared_ptr< monty::ndarray< double,1 > > _5322,std::shared_ptr< monty::ndarray< long long,1 > > _5323,monty::rc_ptr< ::mosek::fusion::Expression > _5324);
static ExprMulElement::t _new_ExprMulElement(std::shared_ptr< monty::ndarray< double,1 > > _5331,std::shared_ptr< monty::ndarray< long long,1 > > _5332,monty::rc_ptr< ::mosek::fusion::Expression > _5333,int _5334);
void _initialize(std::shared_ptr< monty::ndarray< double,1 > > _5331,std::shared_ptr< monty::ndarray< long long,1 > > _5332,monty::rc_ptr< ::mosek::fusion::Expression > _5333,int _5334);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _5335,monty::rc_ptr< ::mosek::fusion::WorkStack > _5336,monty::rc_ptr< ::mosek::fusion::WorkStack > _5337) ;
virtual /* override */ std::string toString() ;
...
static ExprMulScalarConst::t _new_ExprMulScalarConst(double _5395,monty::rc_ptr< ::mosek::fusion::Expression > _5396);
void _initialize(double _5395,monty::rc_ptr< ::mosek::fusion::Expression > _5396);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _5397,monty::rc_ptr< ::mosek::fusion::WorkStack > _5398,monty::rc_ptr< ::mosek::fusion::WorkStack > _5399) ;
virtual /* override */ std::string toString() ;
...
monty::rc_ptr< ::mosek::fusion::Expression > expr{};std::shared_ptr< monty::ndarray< double,1 > > mval{};std::shared_ptr< monty::ndarray< int,1 > > msubj{};std::shared_ptr< monty::ndarray< int,1 > > msubi{};int mdim1{};int mdim0{};virtual void destroy();
static ExprScalarMul::t _new_ExprScalarMul(int _5437,int _5438,std::shared_ptr< monty::ndarray< int,1 > > _5439,std::shared_ptr< monty::ndarray< int,1 > > _5440,std::shared_ptr< monty::ndarray< double,1 > > _5441,monty::rc_ptr< ::mosek::fusion::Expression > _5442,int _5443);
void _initialize(int _5437,int _5438,std::shared_ptr< monty::ndarray< int,1 > > _5439,std::shared_ptr< monty::ndarray< int,1 > > _5440,std::shared_ptr< monty::ndarray< double,1 > > _5441,monty::rc_ptr< ::mosek::fusion::Expression > _5442,int _5443);
static ExprScalarMul::t _new_ExprScalarMul(int _5444,int _5445,std::shared_ptr< monty::ndarray< int,1 > > _5446,std::shared_ptr< monty::ndarray< int,1 > > _5447,std::shared_ptr< monty::ndarray< double,1 > > _5448,monty::rc_ptr< ::mosek::fusion::Expression > _5449);
void _initialize(int _5444,int _5445,std::shared_ptr< monty::ndarray< int,1 > > _5446,std::shared_ptr< monty::ndarray< int,1 > > _5447,std::shared_ptr< monty::ndarray< double,1 > > _5448,monty::rc_ptr< ::mosek::fusion::Expression > _5449);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _5450,monty::rc_ptr< ::mosek::fusion::WorkStack > _5451,monty::rc_ptr< ::mosek::fusion::WorkStack > _5452) ;
static  int validate(int _5488,int _5489,std::shared_ptr< monty::ndarray< int,1 > > _5490,std::shared_ptr< monty::ndarray< int,1 > > _5491,std::shared_ptr< monty::ndarray< double,1 > > _5492,monty::rc_ptr< ::mosek::fusion::Expression > _5493);
virtual /* override */ std::string toString() ;
...
monty::rc_ptr< ::mosek::fusion::Expression > expr{};std::shared_ptr< monty::ndarray< double,1 > > mval{};std::shared_ptr< monty::ndarray< int,1 > > msubj{};std::shared_ptr< monty::ndarray< int,1 > > msubi{};int mdim1{};int mdim0{};virtual void destroy();
static ExprMulRight::t _new_ExprMulRight(int _5500,int _5501,std::shared_ptr< monty::ndarray< int,1 > > _5502,std::shared_ptr< monty::ndarray< int,1 > > _5503,std::shared_ptr< monty::ndarray< double,1 > > _5504,monty::rc_ptr< ::mosek::fusion::Expression > _5505,int _5506);
void _initialize(int _5500,int _5501,std::shared_ptr< monty::ndarray< int,1 > > _5502,std::shared_ptr< monty::ndarray< int,1 > > _5503,std::shared_ptr< monty::ndarray< double,1 > > _5504,monty::rc_ptr< ::mosek::fusion::Expression > _5505,int _5506);
static ExprMulRight::t _new_ExprMulRight(int _5507,int _5508,std::shared_ptr< monty::ndarray< int,1 > > _5509,std::shared_ptr< monty::ndarray< int,1 > > _5510,std::shared_ptr< monty::ndarray< double,1 > > _5511,monty::rc_ptr< ::mosek::fusion::Expression > _5512);
void _initialize(int _5507,int _5508,std::shared_ptr< monty::ndarray< int,1 > > _5509,std::shared_ptr< monty::ndarray< int,1 > > _5510,std::shared_ptr< monty::ndarray< double,1 > > _5511,monty::rc_ptr< ::mosek::fusion::Expression > _5512);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _5513,monty::rc_ptr< ::mosek::fusion::WorkStack > _5514,monty::rc_ptr< ::mosek::fusion::WorkStack > _5515) ;
static  std::shared_ptr< monty::ndarray< int,1 > > computeshape(int _5659,std::shared_ptr< monty::ndarray< int,1 > > _5660);
static  int validate(int _5661,int _5662,std::shared_ptr< monty::ndarray< int,1 > > _5663,std::shared_ptr< monty::ndarray< int,1 > > _5664,std::shared_ptr< monty::ndarray< double,1 > > _5665,monty::rc_ptr< ::mosek::fusion::Expression > _5666);
virtual /* override */ std::string toString() ;
}; // struct ExprMulRight;
...
monty::rc_ptr< ::mosek::fusion::Expression > expr{};std::shared_ptr< monty::ndarray< double,1 > > mval{};std::shared_ptr< monty::ndarray< int,1 > > msubj{};std::shared_ptr< monty::ndarray< int,1 > > msubi{};int mdim1{};int mdim0{};virtual void destroy();
static ExprMulLeft::t _new_ExprMulLeft(int _5675,int _5676,std::shared_ptr< monty::ndarray< int,1 > > _5677,std::shared_ptr< monty::ndarray< int,1 > > _5678,std::shared_ptr< monty::ndarray< double,1 > > _5679,monty::rc_ptr< ::mosek::fusion::Expression > _5680,int _5681);
void _initialize(int _5675,int _5676,std::shared_ptr< monty::ndarray< int,1 > > _5677,std::shared_ptr< monty::ndarray< int,1 > > _5678,std::shared_ptr< monty::ndarray< double,1 > > _5679,monty::rc_ptr< ::mosek::fusion::Expression > _5680,int _5681);
static ExprMulLeft::t _new_ExprMulLeft(int _5682,int _5683,std::shared_ptr< monty::ndarray< int,1 > > _5684,std::shared_ptr< monty::ndarray< int,1 > > _5685,std::shared_ptr< monty::ndarray< double,1 > > _5686,monty::rc_ptr< ::mosek::fusion::Expression > _5687);
void _initialize(int _5682,int _5683,std::shared_ptr< monty::ndarray< int,1 > > _5684,std::shared_ptr< monty::ndarray< int,1 > > _5685,std::shared_ptr< monty::ndarray< double,1 > > _5686,monty::rc_ptr< ::mosek::fusion::Expression > _5687);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _5688,monty::rc_ptr< ::mosek::fusion::WorkStack > _5689,monty::rc_ptr< ::mosek::fusion::WorkStack > _5690) ;
static  std::shared_ptr< monty::ndarray< int,1 > > computeshape(int _5792,int _5793,std::shared_ptr< monty::ndarray< int,1 > > _5794);
static  int validate(int _5795,int _5796,std::shared_ptr< monty::ndarray< int,1 > > _5797,std::shared_ptr< monty::ndarray< int,1 > > _5798,std::shared_ptr< monty::ndarray< double,1 > > _5799,monty::rc_ptr< ::mosek::fusion::Expression > _5800);
virtual /* override */ std::string toString() ;
}; // struct ExprMulLeft;
...
static ExprMulVar::t _new_ExprMulVar(bool _5808,int _5809,int _5810,std::shared_ptr< monty::ndarray< int,1 > > _5811,std::shared_ptr< monty::ndarray< int,1 > > _5812,std::shared_ptr< monty::ndarray< double,1 > > _5813,monty::rc_ptr< ::mosek::fusion::Variable > _5814);
void _initialize(bool _5808,int _5809,int _5810,std::shared_ptr< monty::ndarray< int,1 > > _5811,std::shared_ptr< monty::ndarray< int,1 > > _5812,std::shared_ptr< monty::ndarray< double,1 > > _5813,monty::rc_ptr< ::mosek::fusion::Variable > _5814);
static ExprMulVar::t _new_ExprMulVar(bool _5817,int _5818,int _5819,std::shared_ptr< monty::ndarray< int,1 > > _5820,std::shared_ptr< monty::ndarray< int,1 > > _5821,std::shared_ptr< monty::ndarray< double,1 > > _5822,monty::rc_ptr< ::mosek::fusion::Variable > _5823,int _5824);
void _initialize(bool _5817,int _5818,int _5819,std::shared_ptr< monty::ndarray< int,1 > > _5820,std::shared_ptr< monty::ndarray< int,1 > > _5821,std::shared_ptr< monty::ndarray< double,1 > > _5822,monty::rc_ptr< ::mosek::fusion::Variable > _5823,int _5824);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _5825,monty::rc_ptr< ::mosek::fusion::WorkStack > _5826,monty::rc_ptr< ::mosek::fusion::WorkStack > _5827) ;
virtual void eval_right(monty::rc_ptr< ::mosek::fusion::WorkStack > _5828,monty::rc_ptr< ::mosek::fusion::WorkStack > _5829,monty::rc_ptr< ::mosek::fusion::WorkStack > _5830) ;
virtual void eval_left(monty::rc_ptr< ::mosek::fusion::WorkStack > _5935,monty::rc_ptr< ::mosek::fusion::WorkStack > _5936,monty::rc_ptr< ::mosek::fusion::WorkStack > _5937) ;
virtual void validate(int _6010,int _6011,std::shared_ptr< monty::ndarray< int,1 > > _6012,std::shared_ptr< monty::ndarray< int,1 > > _6013,std::shared_ptr< monty::ndarray< double,1 > > _6014) ;
static  std::shared_ptr< monty::ndarray< int,1 > > resshape(int _6018,int _6019,std::shared_ptr< monty::ndarray< int,1 > > _6020,bool _6021);
virtual /* override */ std::string toString() ;
}; // struct ExprMulVar;
...
static ExprMulScalarVar::t _new_ExprMulScalarVar(int _6022,int _6023,std::shared_ptr< monty::ndarray< int,1 > > _6024,std::shared_ptr< monty::ndarray< int,1 > > _6025,std::shared_ptr< monty::ndarray< double,1 > > _6026,monty::rc_ptr< ::mosek::fusion::Variable > _6027);
void _initialize(int _6022,int _6023,std::shared_ptr< monty::ndarray< int,1 > > _6024,std::shared_ptr< monty::ndarray< int,1 > > _6025,std::shared_ptr< monty::ndarray< double,1 > > _6026,monty::rc_ptr< ::mosek::fusion::Variable > _6027);
static ExprMulScalarVar::t _new_ExprMulScalarVar(int _6032,int _6033,std::shared_ptr< monty::ndarray< int,1 > > _6034,std::shared_ptr< monty::ndarray< int,1 > > _6035,std::shared_ptr< monty::ndarray< double,1 > > _6036,monty::rc_ptr< ::mosek::fusion::Variable > _6037,int _6038);
void _initialize(int _6032,int _6033,std::shared_ptr< monty::ndarray< int,1 > > _6034,std::shared_ptr< monty::ndarray< int,1 > > _6035,std::shared_ptr< monty::ndarray< double,1 > > _6036,monty::rc_ptr< ::mosek::fusion::Variable > _6037,int _6038);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6039,monty::rc_ptr< ::mosek::fusion::WorkStack > _6040,monty::rc_ptr< ::mosek::fusion::WorkStack > _6041) ;
virtual /* override */ std::string toString() ;
...
static ExprMulVarScalarConst::t _new_ExprMulVarScalarConst(monty::rc_ptr< ::mosek::fusion::Variable > _6058,double _6059);
void _initialize(monty::rc_ptr< ::mosek::fusion::Variable > _6058,double _6059);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6060,monty::rc_ptr< ::mosek::fusion::WorkStack > _6061,monty::rc_ptr< ::mosek::fusion::WorkStack > _6062) ;
virtual /* override */ std::string toString() ;
...
static ExprAdd::t _new_ExprAdd(monty::rc_ptr< ::mosek::fusion::Expression > _6079,monty::rc_ptr< ::mosek::fusion::Expression > _6080,double _6081,double _6082);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _6079,monty::rc_ptr< ::mosek::fusion::Expression > _6080,double _6081,double _6082);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6084,monty::rc_ptr< ::mosek::fusion::WorkStack > _6085,monty::rc_ptr< ::mosek::fusion::WorkStack > _6086) ;
virtual /* override */ std::string toString() ;
}; // struct ExprAdd;
...
static ExprWSum::t _new_ExprWSum(std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Expression >,1 > > _6220,std::shared_ptr< monty::ndarray< double,1 > > _6221);
void _initialize(std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Expression >,1 > > _6220,std::shared_ptr< monty::ndarray< double,1 > > _6221);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6228,monty::rc_ptr< ::mosek::fusion::WorkStack > _6229,monty::rc_ptr< ::mosek::fusion::WorkStack > _6230) ;
virtual /* override */ std::string toString() ;
}; // struct ExprWSum;
...
static ExprSumReduce::t _new_ExprSumReduce(int _6324,monty::rc_ptr< ::mosek::fusion::Expression > _6325);
void _initialize(int _6324,monty::rc_ptr< ::mosek::fusion::Expression > _6325);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6327,monty::rc_ptr< ::mosek::fusion::WorkStack > _6328,monty::rc_ptr< ::mosek::fusion::WorkStack > _6329) ;
static  std::shared_ptr< monty::ndarray< int,1 > > computeShape(int _6445,std::shared_ptr< monty::ndarray< int,1 > > _6446);
virtual /* override */ std::string toString() ;
...
static ExprDenseTril::t _new_ExprDenseTril(int _6450,int _6451,monty::rc_ptr< ::mosek::fusion::Expression > _6452,int _6453);
void _initialize(int _6450,int _6451,monty::rc_ptr< ::mosek::fusion::Expression > _6452,int _6453);
static ExprDenseTril::t _new_ExprDenseTril(int _6454,int _6455,monty::rc_ptr< ::mosek::fusion::Expression > _6456);
void _initialize(int _6454,int _6455,monty::rc_ptr< ::mosek::fusion::Expression > _6456);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6458,monty::rc_ptr< ::mosek::fusion::WorkStack > _6459,monty::rc_ptr< ::mosek::fusion::WorkStack > _6460) ;
virtual /* override */ std::string toString() ;
...
monty::rc_ptr< ::mosek::fusion::Expression > expr{};virtual void destroy();
static ExprDense::t _new_ExprDense(monty::rc_ptr< ::mosek::fusion::Expression > _6544);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _6544);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6545,monty::rc_ptr< ::mosek::fusion::WorkStack > _6546,monty::rc_ptr< ::mosek::fusion::WorkStack > _6547) ;
virtual /* override */ std::string toString() ;
}; // struct ExprDense;
...
int dim1{};int dim0{};monty::rc_ptr< ::mosek::fusion::Expression > expr{};virtual void destroy();
static ExprSymmetrize::t _new_ExprSymmetrize(int _6588,int _6589,monty::rc_ptr< ::mosek::fusion::Expression > _6590,int _6591);
void _initialize(int _6588,int _6589,monty::rc_ptr< ::mosek::fusion::Expression > _6590,int _6591);
static ExprSymmetrize::t _new_ExprSymmetrize(int _6592,int _6593,monty::rc_ptr< ::mosek::fusion::Expression > _6594);
void _initialize(int _6592,int _6593,monty::rc_ptr< ::mosek::fusion::Expression > _6594);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6596,monty::rc_ptr< ::mosek::fusion::WorkStack > _6597,monty::rc_ptr< ::mosek::fusion::WorkStack > _6598) ;
virtual /* override */ std::string toString() ;
...
monty::rc_ptr< ::mosek::fusion::Expression > expr{};virtual void destroy();
static ExprCondense::t _new_ExprCondense(monty::rc_ptr< ::mosek::fusion::Expression > _6722);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _6722);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6723,monty::rc_ptr< ::mosek::fusion::WorkStack > _6724,monty::rc_ptr< ::mosek::fusion::WorkStack > _6725) ;
virtual /* override */ std::string toString() ;
}; // struct ExprCondense;
...
static ExprFromVar::t _new_ExprFromVar(monty::rc_ptr< ::mosek::fusion::Variable > _6729);
void _initialize(monty::rc_ptr< ::mosek::fusion::Variable > _6729);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6730,monty::rc_ptr< ::mosek::fusion::WorkStack > _6731,monty::rc_ptr< ::mosek::fusion::WorkStack > _6732) ;
virtual /* override */ std::string toString() ;
}; // struct ExprFromVar;
...
static ExprReshape::t _new_ExprReshape(std::shared_ptr< monty::ndarray< int,1 > > _6749,monty::rc_ptr< ::mosek::fusion::Expression > _6750);
void _initialize(std::shared_ptr< monty::ndarray< int,1 > > _6749,monty::rc_ptr< ::mosek::fusion::Expression > _6750);
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _6752,monty::rc_ptr< ::mosek::fusion::WorkStack > _6753,monty::rc_ptr< ::mosek::fusion::WorkStack > _6754) ;
virtual /* override */ std::string toString() ;
}; // struct ExprReshape;
...
static Expr::t _new_Expr(std::shared_ptr< monty::ndarray< long long,1 > > _6896,std::shared_ptr< monty::ndarray< long long,1 > > _6897,std::shared_ptr< monty::ndarray< double,1 > > _6898,std::shared_ptr< monty::ndarray< double,1 > > _6899,std::shared_ptr< monty::ndarray< int,1 > > _6900,std::shared_ptr< monty::ndarray< long long,1 > > _6901);
void _initialize(std::shared_ptr< monty::ndarray< long long,1 > > _6896,std::shared_ptr< monty::ndarray< long long,1 > > _6897,std::shared_ptr< monty::ndarray< double,1 > > _6898,std::shared_ptr< monty::ndarray< double,1 > > _6899,std::shared_ptr< monty::ndarray< int,1 > > _6900,std::shared_ptr< monty::ndarray< long long,1 > > _6901);
static Expr::t _new_Expr(std::shared_ptr< monty::ndarray< long long,1 > > _6912,std::shared_ptr< monty::ndarray< long long,1 > > _6913,std::shared_ptr< monty::ndarray< double,1 > > _6914,std::shared_ptr< monty::ndarray< double,1 > > _6915,std::shared_ptr< monty::ndarray< int,1 > > _6916,std::shared_ptr< monty::ndarray< long long,1 > > _6917,int _6918);
void _initialize(std::shared_ptr< monty::ndarray< long long,1 > > _6912,std::shared_ptr< monty::ndarray< long long,1 > > _6913,std::shared_ptr< monty::ndarray< double,1 > > _6914,std::shared_ptr< monty::ndarray< double,1 > > _6915,std::shared_ptr< monty::ndarray< int,1 > > _6916,std::shared_ptr< monty::ndarray< long long,1 > > _6917,int _6918);
static Expr::t _new_Expr(monty::rc_ptr< ::mosek::fusion::Expression > _6919);
void _initialize(monty::rc_ptr< ::mosek::fusion::Expression > _6919);
virtual long long prod(std::shared_ptr< monty::ndarray< int,1 > > _6944) ;
static  std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Variable >,1 > > varstack(std::shared_ptr< monty::ndarray< std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Variable >,1 > >,1 > > _6947);
static  std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Variable >,1 > > varstack(std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Variable >,1 > > _6950,std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Variable >,1 > > _6951);
static  monty::rc_ptr< ::mosek::fusion::Expression > condense(monty::rc_ptr< ::mosek::fusion::Expression > _6955);
static  monty::rc_ptr< ::mosek::fusion::Expression > flatten(monty::rc_ptr< ::mosek::fusion::Expression > _6956);
static  monty::rc_ptr< ::mosek::fusion::Expression > reshape(monty::rc_ptr< ::mosek::fusion::Expression > _6958,int _6959,int _6960);
static  monty::rc_ptr< ::mosek::fusion::Expression > reshape(monty::rc_ptr< ::mosek::fusion::Expression > _6961,int _6962);
static  monty::rc_ptr< ::mosek::fusion::Expression > reshape(monty::rc_ptr< ::mosek::fusion::Expression > _6963,std::shared_ptr< monty::ndarray< int,1 > > _6964);
virtual long long size() ;
static  monty::rc_ptr< ::mosek::fusion::Expression > zeros(std::shared_ptr< monty::ndarray< int,1 > > _6965);
static  monty::rc_ptr< ::mosek::fusion::Expression > zeros(int _6966);
static  monty::rc_ptr< ::mosek::fusion::Expression > ones();
static  monty::rc_ptr< ::mosek::fusion::Expression > ones(std::shared_ptr< monty::ndarray< int,1 > > _6967,std::shared_ptr< monty::ndarray< int,2 > > _6968);
static  monty::rc_ptr< ::mosek::fusion::Expression > ones(std::shared_ptr< monty::ndarray< int,1 > > _6969);
static  monty::rc_ptr< ::mosek::fusion::Expression > ones(int _6970);
static  monty::rc_ptr< ::mosek::fusion::Expression > constTerm(monty::rc_ptr< ::mosek::fusion::NDSparseArray > _6971);
static  monty::rc_ptr< ::mosek::fusion::Expression > constTerm(monty::rc_ptr< ::mosek::fusion::Matrix > _6972);
static  monty::rc_ptr< ::mosek::fusion::Expression > constTerm(double _6981);
static  monty::rc_ptr< ::mosek::fusion::Expression > constTerm(std::shared_ptr< monty::ndarray< int,1 > > _6982,std::shared_ptr< monty::ndarray< int,2 > > _6983,double _6984);
static  monty::rc_ptr< ::mosek::fusion::Expression > constTerm(std::shared_ptr< monty::ndarray< int,1 > > _6992,std::shared_ptr< monty::ndarray< int,2 > > _6993,std::shared_ptr< monty::ndarray< double,1 > > _6994);
static  monty::rc_ptr< ::mosek::fusion::Expression > constTerm(std::shared_ptr< monty::ndarray< int,1 > > _7002,double _7003);
static  monty::rc_ptr< ::mosek::fusion::Expression > constTerm(int _7004,double _7005);
static  monty::rc_ptr< ::mosek::fusion::Expression > constTerm(std::shared_ptr< monty::ndarray< double,2 > > _7007);
static  monty::rc_ptr< ::mosek::fusion::Expression > constTerm(std::shared_ptr< monty::ndarray< double,1 > > _7010);
virtual long long numNonzeros() ;
static  monty::rc_ptr< ::mosek::fusion::Expression > sum(monty::rc_ptr< ::mosek::fusion::Expression > _7011,int _7012);
static  monty::rc_ptr< ::mosek::fusion::Expression > sum(monty::rc_ptr< ::mosek::fusion::Expression > _7013);
static  monty::rc_ptr< ::mosek::fusion::Expression > neg(monty::rc_ptr< ::mosek::fusion::Expression > _7014);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(bool _7015,monty::rc_ptr< ::mosek::fusion::Matrix > _7016,monty::rc_ptr< ::mosek::fusion::Expression > _7017);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(monty::rc_ptr< ::mosek::fusion::Variable > _7024,monty::rc_ptr< ::mosek::fusion::Parameter > _7025);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(monty::rc_ptr< ::mosek::fusion::Parameter > _7026,monty::rc_ptr< ::mosek::fusion::Variable > _7027);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(monty::rc_ptr< ::mosek::fusion::Expression > _7028,monty::rc_ptr< ::mosek::fusion::Parameter > _7029);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(monty::rc_ptr< ::mosek::fusion::Parameter > _7030,monty::rc_ptr< ::mosek::fusion::Expression > _7031);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(monty::rc_ptr< ::mosek::fusion::Variable > _7032,monty::rc_ptr< ::mosek::fusion::Matrix > _7033);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(monty::rc_ptr< ::mosek::fusion::Matrix > _7034,monty::rc_ptr< ::mosek::fusion::Variable > _7035);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(monty::rc_ptr< ::mosek::fusion::Expression > _7036,monty::rc_ptr< ::mosek::fusion::Matrix > _7037);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(monty::rc_ptr< ::mosek::fusion::Matrix > _7038,monty::rc_ptr< ::mosek::fusion::Expression > _7039);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(monty::rc_ptr< ::mosek::fusion::Variable > _7040,std::shared_ptr< monty::ndarray< double,2 > > _7041);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(monty::rc_ptr< ::mosek::fusion::Expression > _7048,std::shared_ptr< monty::ndarray< double,2 > > _7049);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(std::shared_ptr< monty::ndarray< double,2 > > _7056,monty::rc_ptr< ::mosek::fusion::Variable > _7057);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulDiag(std::shared_ptr< monty::ndarray< double,2 > > _7064,monty::rc_ptr< ::mosek::fusion::Expression > _7065);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulElm_(monty::rc_ptr< ::mosek::fusion::Matrix > _7072,monty::rc_ptr< ::mosek::fusion::Expression > _7073);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulElm_(std::shared_ptr< monty::ndarray< double,1 > > _7082,monty::rc_ptr< ::mosek::fusion::Expression > _7083);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulElm_(monty::rc_ptr< ::mosek::fusion::NDSparseArray > _7085,monty::rc_ptr< ::mosek::fusion::Expression > _7086);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(monty::rc_ptr< ::mosek::fusion::Expression > _7089,double _7090);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(double _7091,monty::rc_ptr< ::mosek::fusion::Expression > _7092);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(monty::rc_ptr< ::mosek::fusion::Expression > _7093,std::shared_ptr< monty::ndarray< double,1 > > _7094);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(std::shared_ptr< monty::ndarray< double,1 > > _7095,monty::rc_ptr< ::mosek::fusion::Expression > _7096);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(monty::rc_ptr< ::mosek::fusion::Expression > _7097,std::shared_ptr< monty::ndarray< double,2 > > _7098);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(std::shared_ptr< monty::ndarray< double,2 > > _7099,monty::rc_ptr< ::mosek::fusion::Expression > _7100);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(monty::rc_ptr< ::mosek::fusion::Expression > _7101,monty::rc_ptr< ::mosek::fusion::Matrix > _7102);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(monty::rc_ptr< ::mosek::fusion::Matrix > _7103,monty::rc_ptr< ::mosek::fusion::Expression > _7104);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(bool _7105,std::shared_ptr< monty::ndarray< double,1 > > _7106,monty::rc_ptr< ::mosek::fusion::Expression > _7107);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(bool _7122,std::shared_ptr< monty::ndarray< double,2 > > _7123,monty::rc_ptr< ::mosek::fusion::Expression > _7124);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(bool _7139,monty::rc_ptr< ::mosek::fusion::Matrix > _7140,monty::rc_ptr< ::mosek::fusion::Expression > _7141);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(monty::rc_ptr< ::mosek::fusion::Variable > _7150,monty::rc_ptr< ::mosek::fusion::Matrix > _7151);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(monty::rc_ptr< ::mosek::fusion::Matrix > _7157,monty::rc_ptr< ::mosek::fusion::Variable > _7158);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(bool _7164,int _7165,int _7166,std::shared_ptr< monty::ndarray< int,1 > > _7167,std::shared_ptr< monty::ndarray< int,1 > > _7168,std::shared_ptr< monty::ndarray< double,1 > > _7169,monty::rc_ptr< ::mosek::fusion::Variable > _7170);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(monty::rc_ptr< ::mosek::fusion::Expression > _7172,monty::rc_ptr< ::mosek::fusion::Parameter > _7173);
static  monty::rc_ptr< ::mosek::fusion::Expression > mul(monty::rc_ptr< ::mosek::fusion::Parameter > _7174,monty::rc_ptr< ::mosek::fusion::Expression > _7175);
static  monty::rc_ptr< ::mosek::fusion::Expression > dot(monty::rc_ptr< ::mosek::fusion::Expression > _7176,monty::rc_ptr< ::mosek::fusion::Matrix > _7177);
static  monty::rc_ptr< ::mosek::fusion::Expression > dot(monty::rc_ptr< ::mosek::fusion::Expression > _7185,std::shared_ptr< monty::ndarray< double,2 > > _7186);
static  monty::rc_ptr< ::mosek::fusion::Expression > dot(monty::rc_ptr< ::mosek::fusion::Expression > _7190,monty::rc_ptr< ::mosek::fusion::NDSparseArray > _7191);
static  monty::rc_ptr< ::mosek::fusion::Expression > dot(monty::rc_ptr< ::mosek::fusion::Expression > _7192,std::shared_ptr< monty::ndarray< double,1 > > _7193);
static  monty::rc_ptr< ::mosek::fusion::Expression > dot(monty::rc_ptr< ::mosek::fusion::Matrix > _7198,monty::rc_ptr< ::mosek::fusion::Expression > _7199);
static  monty::rc_ptr< ::mosek::fusion::Expression > dot(monty::rc_ptr< ::mosek::fusion::NDSparseArray > _7200,monty::rc_ptr< ::mosek::fusion::Expression > _7201);
static  monty::rc_ptr< ::mosek::fusion::Expression > dot(std::shared_ptr< monty::ndarray< double,2 > > _7202,monty::rc_ptr< ::mosek::fusion::Expression > _7203);
static  monty::rc_ptr< ::mosek::fusion::Expression > dot(std::shared_ptr< monty::ndarray< double,1 > > _7204,monty::rc_ptr< ::mosek::fusion::Expression > _7205);
static  monty::rc_ptr< ::mosek::fusion::Expression > dot(monty::rc_ptr< ::mosek::fusion::Expression > _7206,monty::rc_ptr< ::mosek::fusion::Parameter > _7207);
static  monty::rc_ptr< ::mosek::fusion::Expression > dot(monty::rc_ptr< ::mosek::fusion::Parameter > _7208,monty::rc_ptr< ::mosek::fusion::Expression > _7209);
static  monty::rc_ptr< ::mosek::fusion::Expression > outer(monty::rc_ptr< ::mosek::fusion::Matrix > _7210,monty::rc_ptr< ::mosek::fusion::Variable > _7211);
static  monty::rc_ptr< ::mosek::fusion::Expression > outer(monty::rc_ptr< ::mosek::fusion::Variable > _7218,monty::rc_ptr< ::mosek::fusion::Matrix > _7219);
static  monty::rc_ptr< ::mosek::fusion::Expression > outer(std::shared_ptr< monty::ndarray< double,1 > > _7226,monty::rc_ptr< ::mosek::fusion::Variable > _7227);
static  monty::rc_ptr< ::mosek::fusion::Expression > outer(monty::rc_ptr< ::mosek::fusion::Variable > _7229,std::shared_ptr< monty::ndarray< double,1 > > _7230);
static  monty::rc_ptr< ::mosek::fusion::Expression > outer_(int _7232,std::shared_ptr< monty::ndarray< long long,1 > > _7233,std::shared_ptr< monty::ndarray< long long,1 > > _7234,std::shared_ptr< monty::ndarray< double,1 > > _7235,std::shared_ptr< monty::ndarray< double,1 > > _7236,std::shared_ptr< monty::ndarray< long long,1 > > _7237,std::shared_ptr< monty::ndarray< double,1 > > _7238,std::shared_ptr< monty::ndarray< int,1 > > _7239,int _7240,bool _7241);
static  monty::rc_ptr< ::mosek::fusion::Expression > outer_(monty::rc_ptr< ::mosek::fusion::Variable > _7271,int _7272,std::shared_ptr< monty::ndarray< double,1 > > _7273,std::shared_ptr< monty::ndarray< int,1 > > _7274,int _7275,bool _7276);
static  monty::rc_ptr< ::mosek::fusion::Expression > stack(std::shared_ptr< monty::ndarray< std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Expression >,1 > >,1 > > _7293);
static  monty::rc_ptr< ::mosek::fusion::Expression > vstack(double _7299,double _7300,double _7301);
static  monty::rc_ptr< ::mosek::fusion::Expression > vstack(double _7302,double _7303,monty::rc_ptr< ::mosek::fusion::Expression > _7304);
static  monty::rc_ptr< ::mosek::fusion::Expression > vstack(double _7305,monty::rc_ptr< ::mosek::fusion::Expression > _7306,double _7307);
static  monty::rc_ptr< ::mosek::fusion::Expression > vstack(double _7308,monty::rc_ptr< ::mosek::fusion::Expression > _7309,monty::rc_ptr< ::mosek::fusion::Expression > _7310);
static  monty::rc_ptr< ::mosek::fusion::Expression > vstack(monty::rc_ptr< ::mosek::fusion::Expression > _7311,double _7312,double _7313);
static  monty::rc_ptr< ::mosek::fusion::Expression > vstack(monty::rc_ptr< ::mosek::fusion::Expression > _7314,double _7315,monty::rc_ptr< ::mosek::fusion::Expression > _7316);
static  monty::rc_ptr< ::mosek::fusion::Expression > vstack(monty::rc_ptr< ::mosek::fusion::Expression > _7317,monty::rc_ptr< ::mosek::fusion::Expression > _7318,double _7319);
static  monty::rc_ptr< ::mosek::fusion::Expression > vstack(monty::rc_ptr< ::mosek::fusion::Expression > _7320,monty::rc_ptr< ::mosek::fusion::Expression > _7321,monty::rc_ptr< ::mosek::fusion::Expression > _7322);
static  monty::rc_ptr< ::mosek::fusion::Expression > vstack(double _7323,monty::rc_ptr< ::mosek::fusion::Expression > _7324);
static  monty::rc_ptr< ::mosek::fusion::Expression > vstack(monty::rc_ptr< ::mosek::fusion::Expression > _7325,double _7326);
static  monty::rc_ptr< ::mosek::fusion::Expression > vstack(monty::rc_ptr< ::mosek::fusion::Expression > _7327,monty::rc_ptr< ::mosek::fusion::Expression > _7328);
static  monty::rc_ptr< ::mosek::fusion::Expression > vstack(std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Expression >,1 > > _7329);
static  monty::rc_ptr< ::mosek::fusion::Expression > hstack(monty::rc_ptr< ::mosek::fusion::Expression > _7331,monty::rc_ptr< ::mosek::fusion::Expression > _7332,monty::rc_ptr< ::mosek::fusion::Expression > _7333);
static  monty::rc_ptr< ::mosek::fusion::Expression > hstack(monty::rc_ptr< ::mosek::fusion::Expression > _7334,monty::rc_ptr< ::mosek::fusion::Expression > _7335,double _7336);
static  monty::rc_ptr< ::mosek::fusion::Expression > hstack(monty::rc_ptr< ::mosek::fusion::Expression > _7337,double _7338,monty::rc_ptr< ::mosek::fusion::Expression > _7339);
static  monty::rc_ptr< ::mosek::fusion::Expression > hstack(monty::rc_ptr< ::mosek::fusion::Expression > _7340,double _7341,double _7342);
static  monty::rc_ptr< ::mosek::fusion::Expression > hstack(double _7343,monty::rc_ptr< ::mosek::fusion::Expression > _7344,monty::rc_ptr< ::mosek::fusion::Expression > _7345);
static  monty::rc_ptr< ::mosek::fusion::Expression > hstack(double _7346,monty::rc_ptr< ::mosek::fusion::Expression > _7347,double _7348);
static  monty::rc_ptr< ::mosek::fusion::Expression > hstack(double _7349,double _7350,monty::rc_ptr< ::mosek::fusion::Expression > _7351);
static  monty::rc_ptr< ::mosek::fusion::Expression > hstack(double _7352,monty::rc_ptr< ::mosek::fusion::Expression > _7353);
static  monty::rc_ptr< ::mosek::fusion::Expression > hstack(monty::rc_ptr< ::mosek::fusion::Expression > _7354,double _7355);
static  monty::rc_ptr< ::mosek::fusion::Expression > hstack(monty::rc_ptr< ::mosek::fusion::Expression > _7356,monty::rc_ptr< ::mosek::fusion::Expression > _7357);
static  monty::rc_ptr< ::mosek::fusion::Expression > hstack(std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Expression >,1 > > _7358);
static  monty::rc_ptr< ::mosek::fusion::Expression > stack(int _7360,monty::rc_ptr< ::mosek::fusion::Expression > _7361,monty::rc_ptr< ::mosek::fusion::Expression > _7362,monty::rc_ptr< ::mosek::fusion::Expression > _7363);
static  monty::rc_ptr< ::mosek::fusion::Expression > stack(int _7364,monty::rc_ptr< ::mosek::fusion::Expression > _7365,monty::rc_ptr< ::mosek::fusion::Expression > _7366,double _7367);
static  monty::rc_ptr< ::mosek::fusion::Expression > stack(int _7368,monty::rc_ptr< ::mosek::fusion::Expression > _7369,double _7370,monty::rc_ptr< ::mosek::fusion::Expression > _7371);
static  monty::rc_ptr< ::mosek::fusion::Expression > stack(int _7372,monty::rc_ptr< ::mosek::fusion::Expression > _7373,double _7374,double _7375);
static  monty::rc_ptr< ::mosek::fusion::Expression > stack(int _7376,double _7377,monty::rc_ptr< ::mosek::fusion::Expression > _7378,monty::rc_ptr< ::mosek::fusion::Expression > _7379);
static  monty::rc_ptr< ::mosek::fusion::Expression > stack(int _7380,double _7381,monty::rc_ptr< ::mosek::fusion::Expression > _7382,double _7383);
static  monty::rc_ptr< ::mosek::fusion::Expression > stack(int _7384,double _7385,double _7386,monty::rc_ptr< ::mosek::fusion::Expression > _7387);
static  monty::rc_ptr< ::mosek::fusion::Expression > stack(int _7388,double _7389,monty::rc_ptr< ::mosek::fusion::Expression > _7390);
static  monty::rc_ptr< ::mosek::fusion::Expression > stack(int _7391,monty::rc_ptr< ::mosek::fusion::Expression > _7392,double _7393);
static  monty::rc_ptr< ::mosek::fusion::Expression > stack(int _7394,monty::rc_ptr< ::mosek::fusion::Expression > _7395,monty::rc_ptr< ::mosek::fusion::Expression > _7396);
static  monty::rc_ptr< ::mosek::fusion::Expression > stack(int _7397,std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Expression >,1 > > _7398);
static  monty::rc_ptr< ::mosek::fusion::Expression > stack_(std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Expression >,1 > > _7399,int _7400);
static  std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Expression >,1 > > promote(std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Expression >,1 > > _7401,int _7402);
static  monty::rc_ptr< ::mosek::fusion::Expression > repeat(monty::rc_ptr< ::mosek::fusion::Variable > _7415,int _7416,int _7417);
static  monty::rc_ptr< ::mosek::fusion::Expression > repeat(monty::rc_ptr< ::mosek::fusion::Expression > _7418,int _7419,int _7420);
static  monty::rc_ptr< ::mosek::fusion::Expression > add(std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Expression >,1 > > _7423);
static  monty::rc_ptr< ::mosek::fusion::Expression > add(std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Variable >,1 > > _7425);
static  monty::rc_ptr< ::mosek::fusion::Expression > add_(monty::rc_ptr< ::mosek::fusion::Expression > _7458,double _7459,monty::rc_ptr< ::mosek::fusion::Expression > _7460,double _7461);
static  monty::rc_ptr< ::mosek::fusion::Expression > transpose(monty::rc_ptr< ::mosek::fusion::Expression > _7472);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulElm(monty::rc_ptr< ::mosek::fusion::Matrix > _7473,monty::rc_ptr< ::mosek::fusion::Expression > _7474);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulElm(monty::rc_ptr< ::mosek::fusion::NDSparseArray > _7475,monty::rc_ptr< ::mosek::fusion::Expression > _7476);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulElm(std::shared_ptr< monty::ndarray< double,2 > > _7477,monty::rc_ptr< ::mosek::fusion::Expression > _7478);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulElm(std::shared_ptr< monty::ndarray< double,1 > > _7479,monty::rc_ptr< ::mosek::fusion::Expression > _7480);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulElm(monty::rc_ptr< ::mosek::fusion::Expression > _7481,monty::rc_ptr< ::mosek::fusion::Matrix > _7482);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulElm(monty::rc_ptr< ::mosek::fusion::Expression > _7483,std::shared_ptr< monty::ndarray< double,2 > > _7484);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulElm(monty::rc_ptr< ::mosek::fusion::Expression > _7485,std::shared_ptr< monty::ndarray< double,1 > > _7486);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulElm(monty::rc_ptr< ::mosek::fusion::Expression > _7487,monty::rc_ptr< ::mosek::fusion::NDSparseArray > _7488);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulElm(monty::rc_ptr< ::mosek::fusion::Parameter > _7489,monty::rc_ptr< ::mosek::fusion::Expression > _7490);
static  monty::rc_ptr< ::mosek::fusion::Expression > mulElm(monty::rc_ptr< ::mosek::fusion::Expression > _7491,monty::rc_ptr< ::mosek::fusion::Parameter > _7492);
static  monty::rc_ptr< ::mosek::fusion::Expression > sub(monty::rc_ptr< ::mosek::fusion::NDSparseArray > _7493,monty::rc_ptr< ::mosek::fusion::Expression > _7494);
static  monty::rc_ptr< ::mosek::fusion::Expression > sub(monty::rc_ptr< ::mosek::fusion::Expression > _7495,monty::rc_ptr< ::mosek::fusion::NDSparseArray > _7496);
static  monty::rc_ptr< ::mosek::fusion::Expression > sub(monty::rc_ptr< ::mosek::fusion::Matrix > _7497,monty::rc_ptr< ::mosek::fusion::Expression > _7498);
static  monty::rc_ptr< ::mosek::fusion::Expression > sub(monty::rc_ptr< ::mosek::fusion::Expression > _7499,monty::rc_ptr< ::mosek::fusion::Matrix > _7500);
static  monty::rc_ptr< ::mosek::fusion::Expression > sub(double _7501,monty::rc_ptr< ::mosek::fusion::Expression > _7502);
static  monty::rc_ptr< ::mosek::fusion::Expression > sub(monty::rc_ptr< ::mosek::fusion::Expression > _7503,double _7504);
static  monty::rc_ptr< ::mosek::fusion::Expression > sub(std::shared_ptr< monty::ndarray< double,2 > > _7505,monty::rc_ptr< ::mosek::fusion::Expression > _7506);
static  monty::rc_ptr< ::mosek::fusion::Expression > sub(std::shared_ptr< monty::ndarray< double,1 > > _7507,monty::rc_ptr< ::mosek::fusion::Expression > _7508);
static  monty::rc_ptr< ::mosek::fusion::Expression > sub(monty::rc_ptr< ::mosek::fusion::Expression > _7509,std::shared_ptr< monty::ndarray< double,2 > > _7510);
static  monty::rc_ptr< ::mosek::fusion::Expression > sub(monty::rc_ptr< ::mosek::fusion::Expression > _7511,std::shared_ptr< monty::ndarray< double,1 > > _7512);
static  monty::rc_ptr< ::mosek::fusion::Expression > sub(monty::rc_ptr< ::mosek::fusion::Expression > _7513,monty::rc_ptr< ::mosek::fusion::Expression > _7514);
static  monty::rc_ptr< ::mosek::fusion::Expression > add(monty::rc_ptr< ::mosek::fusion::NDSparseArray > _7515,monty::rc_ptr< ::mosek::fusion::Expression > _7516);
static  monty::rc_ptr< ::mosek::fusion::Expression > add(monty::rc_ptr< ::mosek::fusion::Expression > _7517,monty::rc_ptr< ::mosek::fusion::NDSparseArray > _7518);
static  monty::rc_ptr< ::mosek::fusion::Expression > add(monty::rc_ptr< ::mosek::fusion::Matrix > _7519,monty::rc_ptr< ::mosek::fusion::Expression > _7520);
static  monty::rc_ptr< ::mosek::fusion::Expression > add(monty::rc_ptr< ::mosek::fusion::Expression > _7521,monty::rc_ptr< ::mosek::fusion::Matrix > _7522);
static  monty::rc_ptr< ::mosek::fusion::Expression > add(double _7523,monty::rc_ptr< ::mosek::fusion::Expression > _7524);
static  monty::rc_ptr< ::mosek::fusion::Expression > add(monty::rc_ptr< ::mosek::fusion::Expression > _7525,double _7526);
static  monty::rc_ptr< ::mosek::fusion::Expression > add(std::shared_ptr< monty::ndarray< double,2 > > _7527,monty::rc_ptr< ::mosek::fusion::Expression > _7528);
static  monty::rc_ptr< ::mosek::fusion::Expression > add(std::shared_ptr< monty::ndarray< double,1 > > _7529,monty::rc_ptr< ::mosek::fusion::Expression > _7530);
static  monty::rc_ptr< ::mosek::fusion::Expression > add(monty::rc_ptr< ::mosek::fusion::Expression > _7531,std::shared_ptr< monty::ndarray< double,2 > > _7532);
static  monty::rc_ptr< ::mosek::fusion::Expression > add(monty::rc_ptr< ::mosek::fusion::Expression > _7533,std::shared_ptr< monty::ndarray< double,1 > > _7534);
static  monty::rc_ptr< ::mosek::fusion::Expression > add(monty::rc_ptr< ::mosek::fusion::Expression > _7535,monty::rc_ptr< ::mosek::fusion::Expression > _7536);
virtual /* override */ int getND() ;
virtual /* override */ std::shared_ptr< monty::ndarray< int,1 > > getShape() ;
virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > _7537,monty::rc_ptr< ::mosek::fusion::WorkStack > _7538,monty::rc_ptr< ::mosek::fusion::WorkStack > _7539) ;
static  void validateData(std::shared_ptr< monty::ndarray< long long,1 > > _7555,std::shared_ptr< monty::ndarray< long long,1 > > _7556,std::shared_ptr< monty::ndarray< double,1 > > _7557,std::shared_ptr< monty::ndarray< double,1 > > _7558,std::shared_ptr< monty::ndarray< int,1 > > _7559,std::shared_ptr< monty::ndarray< long long,1 > > _7560);
static  monty::rc_ptr< ::mosek::fusion::Model > extractModel(std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Variable >,1 > > _7573);
}; // struct Expr;
...
virtual int peek_dim(int _6817) ;
virtual int peek_nd() ;
virtual void alloc_expr(int _6818,int _6819,int _6820,bool _6821) ;
virtual void alloc_expr(int _6822,int _6823,int _6824,bool _6825,int _6826) ;
virtual void pop_expr() ;
virtual void move_expr(monty::rc_ptr< ::mosek::fusion::WorkStack > _6827) ;
virtual void peek_expr() ;
virtual void ensure_sparsity() ;
virtual void clear() ;
virtual int allocf64(int _6842) ;
virtual int alloci64(int _6844) ;
virtual int alloci32(int _6846) ;
virtual void pushf64(double _6848) ;
virtual void pushi64(long long _6849) ;
virtual void pushi32(int _6850) ;
virtual void ensuref64(int _6851) ;
virtual void ensurei64(int _6854) ;
virtual void ensurei32(int _6857) ;
virtual int popf64(int _6860) ;
virtual int popi64(int _6861) ;
virtual int popi32(int _6862) ;
virtual void popf64(int _6863,std::shared_ptr< monty::ndarray< double,1 > > _6864,int _6865) ;
virtual void popi64(int _6866,std::shared_ptr< monty::ndarray< long long,1 > > _6867,int _6868) ;
virtual void popi32(int _6869,std::shared_ptr< monty::ndarray< int,1 > > _6870,int _6871) ;
...
virtual int peeki32() ;
virtual double peekf64(int _6872) ;
virtual long long peeki64(int _6873) ;
virtual int peeki32(int _6874) ;
}; // struct WorkStack;
...
static SymmetricExpr::t _new_SymmetricExpr(int _6875,std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::SymmetricMatrix >,1 > > _6876,std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Variable >,1 > > _6877,monty::rc_ptr< ::mosek::fusion::SymmetricMatrix > _6878);
void _initialize(int _6875,std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::SymmetricMatrix >,1 > > _6876,std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Variable >,1 > > _6877,monty::rc_ptr< ::mosek::fusion::SymmetricMatrix > _6878);
static  monty::rc_ptr< ::mosek::fusion::SymmetricExpr > add(monty::rc_ptr< ::mosek::fusion::SymmetricExpr > _6879,monty::rc_ptr< ::mosek::fusion::SymmetricMatrix > _6880);
static  monty::rc_ptr< ::mosek::fusion::SymmetricExpr > mul(monty::rc_ptr< ::mosek::fusion::SymmetricExpr > _6881,double _6882);
static  monty::rc_ptr< ::mosek::fusion::SymmetricExpr > add(monty::rc_ptr< ::mosek::fusion::SymmetricExpr > _6884,monty::rc_ptr< ::mosek::fusion::SymmetricExpr > _6885);
virtual /* override */ std::string toString() ;
...
static SymmetricMatrix::t _new_SymmetricMatrix(int _7586,int _7587,std::shared_ptr< monty::ndarray< int,1 > > _7588,std::shared_ptr< monty::ndarray< int,1 > > _7589,std::shared_ptr< monty::ndarray< double,1 > > _7590,std::shared_ptr< monty::ndarray< int,1 > > _7591,std::shared_ptr< monty::ndarray< int,1 > > _7592,std::shared_ptr< monty::ndarray< double,1 > > _7593,double _7594);
void _initialize(int _7586,int _7587,std::shared_ptr< monty::ndarray< int,1 > > _7588,std::shared_ptr< monty::ndarray< int,1 > > _7589,std::shared_ptr< monty::ndarray< double,1 > > _7590,std::shared_ptr< monty::ndarray< int,1 > > _7591,std::shared_ptr< monty::ndarray< int,1 > > _7592,std::shared_ptr< monty::ndarray< double,1 > > _7593,double _7594);
static  monty::rc_ptr< ::mosek::fusion::SymmetricMatrix > rankOne(int _7595,std::shared_ptr< monty::ndarray< int,1 > > _7596,std::shared_ptr< monty::ndarray< double,1 > > _7597);
static  monty::rc_ptr< ::mosek::fusion::SymmetricMatrix > rankOne(std::shared_ptr< monty::ndarray< double,1 > > _7605);
static  monty::rc_ptr< ::mosek::fusion::SymmetricMatrix > antiDiag(std::shared_ptr< monty::ndarray< double,1 > > _7613);
static  monty::rc_ptr< ::mosek::fusion::SymmetricMatrix > diag(std::shared_ptr< monty::ndarray< double,1 > > _7620);
virtual monty::rc_ptr< ::mosek::fusion::SymmetricMatrix > __mosek_2fusion_2SymmetricMatrix__add(monty::rc_ptr< ::mosek::fusion::SymmetricMatrix > _7626) ;
virtual monty::rc_ptr< ::mosek::fusion::SymmetricMatrix > __mosek_2fusion_2SymmetricMatrix__sub(monty::rc_ptr< ::mosek::fusion::SymmetricMatrix > _7646) ;
virtual monty::rc_ptr< ::mosek::fusion::SymmetricMatrix > __mosek_2fusion_2SymmetricMatrix__mul(double _7647) ;
virtual int getdim() ;
...
static NDSparseArray::t _new_NDSparseArray(std::shared_ptr< monty::ndarray< int,1 > > _7648,std::shared_ptr< monty::ndarray< int,2 > > _7649,std::shared_ptr< monty::ndarray< double,1 > > _7650);
void _initialize(std::shared_ptr< monty::ndarray< int,1 > > _7648,std::shared_ptr< monty::ndarray< int,2 > > _7649,std::shared_ptr< monty::ndarray< double,1 > > _7650);
static NDSparseArray::t _new_NDSparseArray(std::shared_ptr< monty::ndarray< int,1 > > _7671,std::shared_ptr< monty::ndarray< long long,1 > > _7672,std::shared_ptr< monty::ndarray< double,1 > > _7673);
void _initialize(std::shared_ptr< monty::ndarray< int,1 > > _7671,std::shared_ptr< monty::ndarray< long long,1 > > _7672,std::shared_ptr< monty::ndarray< double,1 > > _7673);
static NDSparseArray::t _new_NDSparseArray(monty::rc_ptr< ::mosek::fusion::Matrix > _7689);
void _initialize(monty::rc_ptr< ::mosek::fusion::Matrix > _7689);
static  monty::rc_ptr< ::mosek::fusion::NDSparseArray > make(monty::rc_ptr< ::mosek::fusion::Matrix > _7697);
static  monty::rc_ptr< ::mosek::fusion::NDSparseArray > make(std::shared_ptr< monty::ndarray< int,1 > > _7698,std::shared_ptr< monty::ndarray< long long,1 > > _7699,std::shared_ptr< monty::ndarray< double,1 > > _7700);
static  monty::rc_ptr< ::mosek::fusion::NDSparseArray > make(std::shared_ptr< monty::ndarray< int,1 > > _7701,std::shared_ptr< monty::ndarray< int,2 > > _7702,std::shared_ptr< monty::ndarray< double,1 > > _7703);
...
static Matrix::t _new_Matrix(int _7773,int _7774);
void _initialize(int _7773,int _7774);
virtual /* override */ std::string toString() ;
virtual void switchDims() ;
static  monty::rc_ptr< ::mosek::fusion::Matrix > diag(int _7776,monty::rc_ptr< ::mosek::fusion::Matrix > _7777);
static  monty::rc_ptr< ::mosek::fusion::Matrix > diag(std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Matrix >,1 > > _7779);
static  monty::rc_ptr< ::mosek::fusion::Matrix > antidiag(int _7797,double _7798,int _7799);
static  monty::rc_ptr< ::mosek::fusion::Matrix > antidiag(int _7800,double _7801);
static  monty::rc_ptr< ::mosek::fusion::Matrix > diag(int _7802,double _7803,int _7804);
static  monty::rc_ptr< ::mosek::fusion::Matrix > diag(int _7805,double _7806);
static  monty::rc_ptr< ::mosek::fusion::Matrix > antidiag(std::shared_ptr< monty::ndarray< double,1 > > _7807,int _7808);
static  monty::rc_ptr< ::mosek::fusion::Matrix > antidiag(std::shared_ptr< monty::ndarray< double,1 > > _7818);
static  monty::rc_ptr< ::mosek::fusion::Matrix > diag(std::shared_ptr< monty::ndarray< double,1 > > _7819,int _7820);
static  monty::rc_ptr< ::mosek::fusion::Matrix > diag(std::shared_ptr< monty::ndarray< double,1 > > _7828);
static  monty::rc_ptr< ::mosek::fusion::Matrix > ones(int _7829,int _7830);
static  monty::rc_ptr< ::mosek::fusion::Matrix > eye(int _7831);
static  monty::rc_ptr< ::mosek::fusion::Matrix > dense(monty::rc_ptr< ::mosek::fusion::Matrix > _7833);
static  monty::rc_ptr< ::mosek::fusion::Matrix > dense(int _7834,int _7835,double _7836);
static  monty::rc_ptr< ::mosek::fusion::Matrix > dense(int _7837,int _7838,std::shared_ptr< monty::ndarray< double,1 > > _7839);
static  monty::rc_ptr< ::mosek::fusion::Matrix > dense(std::shared_ptr< monty::ndarray< double,2 > > _7840);
static  monty::rc_ptr< ::mosek::fusion::Matrix > sparse(monty::rc_ptr< ::mosek::fusion::Matrix > _7841);
static  monty::rc_ptr< ::mosek::fusion::Matrix > sparse(std::shared_ptr< monty::ndarray< std::shared_ptr< monty::ndarray< monty::rc_ptr< ::mosek::fusion::Matrix >,1 > >,1 > > _7845);
static  monty::rc_ptr< ::mosek::fusion::Matrix > sparse(std::shared_ptr< monty::ndarray< double,2 > > _7876);
static  monty::rc_ptr< ::mosek::fusion::Matrix > sparse(int _7886,int _7887);
static  monty::rc_ptr< ::mosek::fusion::Matrix > sparse(int _7888,int _7889,std::shared_ptr< monty::ndarray< int,1 > > _7890,std::shared_ptr< monty::ndarray< int,1 > > _7891,double _7892);
static  monty::rc_ptr< ::mosek::fusion::Matrix > sparse(std::shared_ptr< monty::ndarray< int,1 > > _7894,std::shared_ptr< monty::ndarray< int,1 > > _7895,double _7896);
static  monty::rc_ptr< ::mosek::fusion::Matrix > sparse(std::shared_ptr< monty::ndarray< int,1 > > _7901,std::shared_ptr< monty::ndarray< int,1 > > _7902,std::shared_ptr< monty::ndarray< double,1 > > _7903);
static  monty::rc_ptr< ::mosek::fusion::Matrix > sparse(int _7908,int _7909,std::shared_ptr< monty::ndarray< int,1 > > _7910,std::shared_ptr< monty::ndarray< int,1 > > _7911,std::shared_ptr< monty::ndarray< double,1 > > _7912);
virtual double get(int _7917,int _7918) { throw monty::AbstractClassError("Call to abstract method"); }
...
virtual void getDataAsTriplets(std::shared_ptr< monty::ndarray< int,1 > > _7919,std::shared_ptr< monty::ndarray< int,1 > > _7920,std::shared_ptr< monty::ndarray< double,1 > > _7921) { throw monty::AbstractClassError("Call to abstract method"); }
...
static DenseMatrix::t _new_DenseMatrix(int _7704,int _7705,std::shared_ptr< monty::ndarray< double,1 > > _7706);
void _initialize(int _7704,int _7705,std::shared_ptr< monty::ndarray< double,1 > > _7706);
static DenseMatrix::t _new_DenseMatrix(monty::rc_ptr< ::mosek::fusion::Matrix > _7707);
void _initialize(monty::rc_ptr< ::mosek::fusion::Matrix > _7707);
static DenseMatrix::t _new_DenseMatrix(std::shared_ptr< monty::ndarray< double,2 > > _7712);
void _initialize(std::shared_ptr< monty::ndarray< double,2 > > _7712);
static DenseMatrix::t _new_DenseMatrix(int _7715,int _7716,double _7717);
void _initialize(int _7715,int _7716,double _7717);
virtual /* override */ std::string toString() ;
...
virtual /* override */ void getDataAsTriplets(std::shared_ptr< monty::ndarray< int,1 > > _7730,std::shared_ptr< monty::ndarray< int,1 > > _7731,std::shared_ptr< monty::ndarray< double,1 > > _7732) ;
virtual /* override */ double get(int _7736,int _7737) ;
...
static SparseMatrix::t _new_SparseMatrix(int _7738,int _7739,std::shared_ptr< monty::ndarray< int,1 > > _7740,std::shared_ptr< monty::ndarray< int,1 > > _7741,std::shared_ptr< monty::ndarray< double,1 > > _7742,long long _7743);
void _initialize(int _7738,int _7739,std::shared_ptr< monty::ndarray< int,1 > > _7740,std::shared_ptr< monty::ndarray< int,1 > > _7741,std::shared_ptr< monty::ndarray< double,1 > > _7742,long long _7743);
static SparseMatrix::t _new_SparseMatrix(int _7749,int _7750,std::shared_ptr< monty::ndarray< int,1 > > _7751,std::shared_ptr< monty::ndarray< int,1 > > _7752,std::shared_ptr< monty::ndarray< double,1 > > _7753);
void _initialize(int _7749,int _7750,std::shared_ptr< monty::ndarray< int,1 > > _7751,std::shared_ptr< monty::ndarray< int,1 > > _7752,std::shared_ptr< monty::ndarray< double,1 > > _7753);
...
virtual /* override */ bool isSparse() ;
virtual /* override */ std::shared_ptr< monty::ndarray< double,1 > > getDataAsArray() ;
virtual /* override */ void getDataAsTriplets(std::shared_ptr< monty::ndarray< int,1 > > _7765,std::shared_ptr< monty::ndarray< int,1 > > _7766,std::shared_ptr< monty::ndarray< double,1 > > _7767) ;
virtual /* override */ double get(int _7768,int _7769) ;
}; // struct SparseMatrix;
...
void _initialize();
static LinkedBlocks::t _new_LinkedBlocks(int _7947);
void _initialize(int _7947);
static LinkedBlocks::t _new_LinkedBlocks(monty::rc_ptr< ::mosek::fusion::LinkedBlocks > _7948);
void _initialize(monty::rc_ptr< ::mosek::fusion::LinkedBlocks > _7948);
virtual void free(int _7949) ;
virtual int alloc(int _7951) ;
virtual int maxidx(int _7956) ;
virtual void get(int _7957,std::shared_ptr< monty::ndarray< int,1 > > _7958,int _7959) ;
virtual int numblocks() ;
virtual int blocksize(int _7960) ;
...
static LinkedInts::t _new_LinkedInts(int _7961);
void _initialize(int _7961);
static LinkedInts::t _new_LinkedInts();
void _initialize();
static LinkedInts::t _new_LinkedInts(monty::rc_ptr< ::mosek::fusion::LinkedInts > _7964);
void _initialize(monty::rc_ptr< ::mosek::fusion::LinkedInts > _7964);
virtual void free(int _7965,int _7966) ;
virtual int alloc() ;
virtual int alloc(int _7972) ;
virtual void alloc(int _7973,std::shared_ptr< monty::ndarray< int,1 > > _7974,int _7975) ;
virtual void get(int _7978,int _7979,std::shared_ptr< monty::ndarray< int,1 > > _7980,int _7981) ;
virtual int maxidx(int _7984,int _7985) ;
virtual int allocblock(int _7989) ;
virtual void recap(int _7995) ;
virtual int capacity() ;
virtual bool validate() ;
}; // struct LinkedInts;
...
virtual void destroy();
static  void setParameter(monty::rc_ptr< ::mosek::fusion::Model > _8004,const std::string &  _8005,double _8006);
static  void setParameter(monty::rc_ptr< ::mosek::fusion::Model > _8100,const std::string &  _8101,int _8102);
static  void setParameter(monty::rc_ptr< ::mosek::fusion::Model > _8196,const std::string &  _8197,const std::string &  _8198);
static  int string_to_inftype_value(const std::string &  _8436);
static  int string_to_branchdir_value(const std::string &  _8437);
static  int string_to_sensitivitytype_value(const std::string &  _8438);
static  int string_to_iinfitem_value(const std::string &  _8439);
static  int string_to_scopr_value(const std::string &  _8440);
static  int string_to_startpointtype_value(const std::string &  _8441);
static  int string_to_conetype_value(const std::string &  _8442);
static  int string_to_rescodetype_value(const std::string &  _8443);
static  int string_to_iparam_value(const std::string &  _8444);
static  int string_to_orderingtype_value(const std::string &  _8445);
static  int string_to_uplo_value(const std::string &  _8446);
static  int string_to_solsta_value(const std::string &  _8447);
static  int string_to_xmlwriteroutputtype_value(const std::string &  _8448);
static  int string_to_iomode_value(const std::string &  _8449);
static  int string_to_boundkey_value(const std::string &  _8450);
static  int string_to_dparam_value(const std::string &  _8451);
static  int string_to_sparam_value(const std::string &  _8452);
static  int string_to_language_value(const std::string &  _8453);
static  int string_to_solveform_value(const std::string &  _8454);
static  int string_to_dinfitem_value(const std::string &  _8455);
static  int string_to_compresstype_value(const std::string &  _8456);
static  int string_to_variabletype_value(const std::string &  _8457);
static  int string_to_optimizertype_value(const std::string &  _8458);
static  int string_to_scalingmethod_value(const std::string &  _8459);
static  int string_to_mionodeseltype_value(const std::string &  _8460);
static  int string_to_internal_liinf_value(const std::string &  _8461);
static  int string_to_rescode_value(const std::string &  _8462);
static  int string_to_liinfitem_value(const std::string &  _8463);
static  int string_to_simreform_value(const std::string &  _8464);
static  int string_to_transpose_value(const std::string &  _8465);
static  int string_to_dataformat_value(const std::string &  _8466);
static  int string_to_mpsformat_value(const std::string &  _8467);
static  int string_to_onoffkey_value(const std::string &  _8468);
static  int string_to_basindtype_value(const std::string &  _8469);
static  int string_to_solitem_value(const std::string &  _8470);
static  int string_to_miocontsoltype_value(const std::string &  _8471);
static  int string_to_simseltype_value(const std::string &  _8472);
static  int string_to_simdupvec_value(const std::string &  _8473);
static  int string_to_parametertype_value(const std::string &  _8474);
static  int string_to_prosta_value(const std::string &  _8475);
static  int string_to_objsense_value(const std::string &  _8476);
static  int string_to_presolvemode_value(const std::string &  _8477);
static  int string_to_internal_iinf_value(const std::string &  _8478);
static  int string_to_simdegen_value(const std::string &  _8479);
static  int string_to_checkconvexitytype_value(const std::string &  _8480);
static  int string_to_scalingtype_value(const std::string &  _8481);
static  int string_to_problemitem_value(const std::string &  _8482);
static  int string_to_value_value(const std::string &  _8483);
static  int string_to_purify_value(const std::string &  _8484);
static  int string_to_internal_dinf_value(const std::string &  _8485);
static  int string_to_stakey_value(const std::string &  _8486);
static  int string_to_problemtype_value(const std::string &  _8487);
static  int string_to_simhotstart_value(const std::string &  _8488);
static  int string_to_miomode_value(const std::string &  _8489);
static  int string_to_nametype_value(const std::string &  _8490);
static  int string_to_soltype_value(const std::string &  _8491);
static  int string_to_feature_value(const std::string &  _8492);
static  int string_to_streamtype_value(const std::string &  _8493);
static  int string_to_symmattype_value(const std::string &  _8494);
static  int string_to_mark_value(const std::string &  _8495);
static  int string_to_intpnthotstart_value(const std::string &  _8496);
static  int string_to_callbackcode_value(const std::string &  _8497);
}; // struct Parameters;
