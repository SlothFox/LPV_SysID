...
LSS=loadmat("./Benchmarks/Bioreactor/Bioreactor_LSS_3states")
LSS=LSS['Results']
...
initial_params = {'A': LSS['A'][0][0],
                  ...
                  'range_x': np.array([[0.008,0.213],[-0.163,0.055],
                                       [0.004,0.0978]])}
...
for dim in [1,2,3,4,5,10]:
    ...
    pkl.dump(identification_results,open('Bioreactor_RBF_3states_theta'+str(dim)+'.pkl',
                                         'wb'))
