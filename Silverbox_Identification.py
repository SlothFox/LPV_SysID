...
model = Model.RehmerLPV(dim_u=1,dim_x=2,dim_y=1,dim_thetaA=1,dim_thetaB=0,
...
identification_results = ModelTraining(model,data,1,initial_params=initial_params)
